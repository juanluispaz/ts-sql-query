...
import type { ITable, IWithView, ITableOrView, HasIsValue, OfDB } from './utils/ITableOrView.js'
import { __addWiths, __registerTableOrView, __registerRequiredColumn, __getTableOrViewPrivate } from './utils/ITableOrView.js'
import type { TypeAdapter } from './TypeAdapter.js'
import type { AliasedTableOrView, AutogeneratedPrimaryKeyColumnsTypesOf, AsOldValues, AsValuesForInsert, AsForUseInLeftJoin, AsAliasedForUseInLeftJoin } from './utils/tableOrViewUtils.js'
import type { Column, ColumnWithDefaultValue, DBColumn, PrimaryKeyAutogeneratedColumn, PrimaryKeyColumn } from './utils/Column.js'
...
import type { NNoTableOrViewRequiredFrom, NSourceAllowingNoTableOrViewRequired, NTable } from './utils/sourceName.js'
...
class TableOf</*in|out*/ SOURCE extends NTable<any, any>> implements ITable<SOURCE> {
    ...
    oldValues(this: OfDB<'mariaDB'>) : AsOldValues<this>
    ...
    oldValues(this: OfDB<'postgreSql' | 'sqlServer' | 'mariaDB' | 'noopDB'>): never
    oldValues(): any {
        const result = new ((this as any).constructor)() as TableOf<any>
        result.__as = '_old_'
    ...
    protected autogeneratedPrimaryKeyBySequence(this: OfDB<'mariaDB' | 'oracle' | 'postgreSql' | 'sqlServer'>, name: string, sequenceName: string, type: 'boolean', adapter?: TypeAdapter): BooleanValueSource<SOURCE, 'required'> & PrimaryKeyAutogeneratedColumn
    protected autogeneratedPrimaryKeyBySequence(this: OfDB<'mariaDB' | 'oracle' | 'postgreSql' | 'sqlServer'>, name: string, sequenceName: string, type: 'int', adapter?: TypeAdapter): NumberValueSource<SOURCE, 'required'> & PrimaryKeyAutogeneratedColumn
    protected autogeneratedPrimaryKeyBySequence(this: OfDB<'mariaDB' | 'oracle' | 'postgreSql' | 'sqlServer'>, name: string, sequenceName: string, type: 'bigint', adapter?: TypeAdapter): BigintValueSource<SOURCE, 'required'> & PrimaryKeyAutogeneratedColumn
    protected autogeneratedPrimaryKeyBySequence(this: OfDB<'mariaDB' | 'oracle' | 'postgreSql' | 'sqlServer'>, name: string, sequenceName: string, type: 'double', adapter?: TypeAdapter): NumberValueSource<SOURCE, 'required'> & PrimaryKeyAutogeneratedColumn
    protected autogeneratedPrimaryKeyBySequence(this: OfDB<'mariaDB' | 'oracle' | 'postgreSql' | 'sqlServer'>, name: string, sequenceName: string, type: 'string', adapter?: TypeAdapter): StringValueSource<SOURCE, 'required'> & PrimaryKeyAutogeneratedColumn
    protected autogeneratedPrimaryKeyBySequence(this: OfDB<'mariaDB' | 'oracle' | 'postgreSql' | 'sqlServer'>, name: string, sequenceName: string, type: 'uuid', adapter?: TypeAdapter): UuidValueSource<SOURCE, 'required'> & PrimaryKeyAutogeneratedColumn
    protected autogeneratedPrimaryKeyBySequence(this: OfDB<'mariaDB' | 'oracle' | 'postgreSql' | 'sqlServer'>, name: string, sequenceName: string, type: 'localDate', adapter?: TypeAdapter): LocalDateValueSource<SOURCE, 'required'> & PrimaryKeyAutogeneratedColumn
    protected autogeneratedPrimaryKeyBySequence(this: OfDB<'mariaDB' | 'oracle' | 'postgreSql' | 'sqlServer'>, name: string, sequenceName: string, type: 'localTime', adapter?: TypeAdapter): LocalTimeValueSource<SOURCE, 'required'> & PrimaryKeyAutogeneratedColumn
    protected autogeneratedPrimaryKeyBySequence(this: OfDB<'mariaDB' | 'oracle' | 'postgreSql' | 'sqlServer'>, name: string, sequenceName: string, type: 'localDateTime', adapter?: TypeAdapter): LocalDateTimeValueSource<SOURCE, 'required'> & PrimaryKeyAutogeneratedColumn
    protected autogeneratedPrimaryKeyBySequence<T, TYPE_NAME extends string>(this: OfDB<'mariaDB' | 'oracle' | 'postgreSql' | 'sqlServer'>, name: string, sequenceName: string, type: 'customInt', typeName: TYPE_NAME, adapter?: TypeAdapter): CustomIntValueSource<SOURCE, T, TYPE_NAME, 'required'> & PrimaryKeyAutogeneratedColumn
    protected autogeneratedPrimaryKeyBySequence<T, TYPE_NAME extends string>(this: OfDB<'mariaDB' | 'oracle' | 'postgreSql' | 'sqlServer'>, name: string, sequenceName: string, type: 'customDouble', typeName: TYPE_NAME, adapter?: TypeAdapter): CustomDoubleValueSource<SOURCE, T, TYPE_NAME, 'required'> & PrimaryKeyAutogeneratedColumn
    protected autogeneratedPrimaryKeyBySequence<T, TYPE_NAME extends string>(this: OfDB<'mariaDB' | 'oracle' | 'postgreSql' | 'sqlServer'>, name: string, sequenceName: string, type: 'customUuid', typeName: TYPE_NAME, adapter?: TypeAdapter): CustomUuidValueSource<SOURCE, T, TYPE_NAME, 'required'> & PrimaryKeyAutogeneratedColumn
    protected autogeneratedPrimaryKeyBySequence<T, TYPE_NAME extends string>(this: OfDB<'mariaDB' | 'oracle' | 'postgreSql' | 'sqlServer'>, name: string, sequenceName: string, type: 'customLocalDate', typeName: TYPE_NAME, adapter?: TypeAdapter): CustomLocalDateValueSource<SOURCE, T, TYPE_NAME, 'required'> & PrimaryKeyAutogeneratedColumn
    protected autogeneratedPrimaryKeyBySequence<T, TYPE_NAME extends string>(this: OfDB<'mariaDB' | 'oracle' | 'postgreSql' | 'sqlServer'>, name: string, sequenceName: string, type: 'customLocalTime', typeName: TYPE_NAME, adapter?: TypeAdapter): CustomLocalTimeValueSource<SOURCE, T, TYPE_NAME, 'required'> & PrimaryKeyAutogeneratedColumn
    protected autogeneratedPrimaryKeyBySequence<T, TYPE_NAME extends string>(this: OfDB<'mariaDB' | 'oracle' | 'postgreSql' | 'sqlServer'>, name: string, sequenceName: string, type: 'customLocalDateTime', typeName: TYPE_NAME, adapter?: TypeAdapter): CustomLocalDateTimeValueSource<SOURCE, T, TYPE_NAME, 'required'> & PrimaryKeyAutogeneratedColumn
    protected autogeneratedPrimaryKeyBySequence<T, TYPE_NAME extends string>(this: OfDB<'mariaDB' | 'oracle' | 'postgreSql' | 'sqlServer'>, name: string, sequenceName: string, type: 'enum', typeName: TYPE_NAME, adapter?: TypeAdapter): EqualableValueSource<SOURCE, T, TYPE_NAME, 'required'> & PrimaryKeyAutogeneratedColumn
    protected autogeneratedPrimaryKeyBySequence<T, TYPE_NAME extends string>(this: OfDB<'mariaDB' | 'oracle' | 'postgreSql' | 'sqlServer'>, name: string, sequenceName: string, type: 'custom', typeName: TYPE_NAME, adapter?: TypeAdapter): EqualableValueSource<SOURCE, T, TYPE_NAME, 'required'> & PrimaryKeyAutogeneratedColumn
    protected autogeneratedPrimaryKeyBySequence<T, TYPE_NAME extends string>(this: OfDB<'mariaDB' | 'oracle' | 'postgreSql' | 'sqlServer'>, name: string, sequenceName: string, type: 'customComparable', typeName: TYPE_NAME, adapter?: TypeAdapter): ComparableValueSource<SOURCE, T, TYPE_NAME, 'required'> & PrimaryKeyAutogeneratedColumn
    protected autogeneratedPrimaryKeyBySequence<T>(this: OfDB<'mariaDB' | 'oracle' | 'postgreSql' | 'sqlServer'>, name: string, sequenceName: string, type: 'customInt', typeName: string, adapter?: TypeAdapter): CustomIntValueSource<SOURCE, T, T, 'required'> & PrimaryKeyAutogeneratedColumn
    protected autogeneratedPrimaryKeyBySequence<T>(this: OfDB<'mariaDB' | 'oracle' | 'postgreSql' | 'sqlServer'>, name: string, sequenceName: string, type: 'customDouble', typeName: string, adapter?: TypeAdapter): CustomDoubleValueSource<SOURCE, T, T, 'required'> & PrimaryKeyAutogeneratedColumn
    protected autogeneratedPrimaryKeyBySequence<T>(this: OfDB<'mariaDB' | 'oracle' | 'postgreSql' | 'sqlServer'>, name: string, sequenceName: string, type: 'customUuid', typeName: string, adapter?: TypeAdapter): CustomUuidValueSource<SOURCE, T, T, 'required'> & PrimaryKeyAutogeneratedColumn
    protected autogeneratedPrimaryKeyBySequence<T>(this: OfDB<'mariaDB' | 'oracle' | 'postgreSql' | 'sqlServer'>, name: string, sequenceName: string, type: 'customLocalDate', typeName: string, adapter?: TypeAdapter): CustomLocalDateValueSource<SOURCE, T, T, 'required'> & PrimaryKeyAutogeneratedColumn
    protected autogeneratedPrimaryKeyBySequence<T>(this: OfDB<'mariaDB' | 'oracle' | 'postgreSql' | 'sqlServer'>, name: string, sequenceName: string, type: 'customLocalTime', typeName: string, adapter?: TypeAdapter): CustomLocalTimeValueSource<SOURCE, T, T, 'required'> & PrimaryKeyAutogeneratedColumn
    protected autogeneratedPrimaryKeyBySequence<T>(this: OfDB<'mariaDB' | 'oracle' | 'postgreSql' | 'sqlServer'>, name: string, sequenceName: string, type: 'customLocalDateTime', typeName: string, adapter?: TypeAdapter): CustomLocalDateTimeValueSource<SOURCE, T, T, 'required'> & PrimaryKeyAutogeneratedColumn
    protected autogeneratedPrimaryKeyBySequence<T>(this: OfDB<'mariaDB' | 'oracle' | 'postgreSql' | 'sqlServer'>, name: string, sequenceName: string, type: 'enum', typeName: string, adapter?: TypeAdapter): EqualableValueSource<SOURCE, T, T, 'required'> & PrimaryKeyAutogeneratedColumn
    protected autogeneratedPrimaryKeyBySequence<T>(this: OfDB<'mariaDB' | 'oracle' | 'postgreSql' | 'sqlServer'>, name: string, sequenceName: string, type: 'custom', typeName: string, adapter?: TypeAdapter): EqualableValueSource<SOURCE, T, T, 'required'> & PrimaryKeyAutogeneratedColumn
    protected autogeneratedPrimaryKeyBySequence<T>(this: OfDB<'mariaDB' | 'oracle' | 'postgreSql' | 'sqlServer'>, name: string, sequenceName: string, type: 'customComparable', typeName: string, adapter?: TypeAdapter): ComparableValueSource<SOURCE, T, T, 'required'> & PrimaryKeyAutogeneratedColumn
