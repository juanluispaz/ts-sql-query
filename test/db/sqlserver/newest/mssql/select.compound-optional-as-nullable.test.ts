...
describe(ctx.label, () => {
    ...
    test('compound-optional-flat-leaf-as-nullable-surfaces-null', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as iid, body as body from issue where id = @0 union select id as iid, body as body from issue where id = @1 order by iid"`)
    ...
    test('compound-three-arm-projecting-optionals-as-nullable-exec', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as iid, body as body from issue where id = @0 union select id as iid, body as body from issue where id = @1 union select id as iid, body as body from issue where id = @2 order by iid"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
            2,
    ...
    test('compound-three-arm-projecting-optionals-as-nullable-inline', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select (select a_1_.iid as iid, a_1_.body as body from (select id as iid, body as body from issue where id = @0 union select id as iid, body as body from issue where id = @1 union select id as iid, body as body from issue where id = @2) as a_1_ for json path) as arr"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
            2,
    ...
    test('compound-before-op-unionAll-nullable-inline', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select (select a_1_.iid as iid, a_1_.body as body from (select id as iid, body as body from issue where id = @0 union all select id as iid, body as body from issue where id = @1) as a_1_ for json path) as arr"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
            2,
    ...
    test('compound-before-op-intersect-nullable-inline', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select (select a_1_.iid as iid, a_1_.body as body from (select id as iid, body as body from issue where id in (@0, @1) intersect select id as iid, body as body from issue where id = @2) as a_1_ for json path) as arr"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
            2,
    ...
    */
    ...
    test('compound-before-op-except-nullable-inline', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select (select a_1_.iid as iid, a_1_.body as body from (select id as iid, body as body from issue where id in (@0, @1) except select id as iid, body as body from issue where id = @2) as a_1_ for json path) as arr"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
            2,
