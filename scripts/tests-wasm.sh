...
Flags:
  ...
  --coverage-format <name>              Repeatable; default html when
                                        ...
                                        plus the special `monocart`
                                        value (switches provider to
                                        vitest-monocart-coverage). Under
                                        bun, restricted to
                                        html|text|lcov|monocart
                                        (monocart post-renders the lcov
                                        via MCR; monocart + html error
                                        since both write index.html).
