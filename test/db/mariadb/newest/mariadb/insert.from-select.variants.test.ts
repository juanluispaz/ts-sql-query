...
describe(ctx.label, () => {
    ...
    // emits here with a parse error at `insert`. MariaDB accepts CTEs
    // inside a SELECT but not as the prefix of an INSERT statement.
    // See other cells for the canonical body.
    /*
