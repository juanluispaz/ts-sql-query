...
// `forceTypeCast = true` branch. When a
...
describe(ctx.label, () => {
    ...
    test('const-custom-string-falls-through-without-cast', async () => {
        // A `custom` typeName whose value is
