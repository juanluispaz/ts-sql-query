...
describe(ctx.label, () => {
    ...
    test('worklog-boolean-virtual-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", case when (billable = 1) then 1 else 0 end as "v" from issue_worklog where id = :0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('worklog-boolean-virtual-optional', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", case when (billable = 1) then 1 when not (billable = 1) then 0 else null end as "v" from issue_worklog where id = :0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('release-custom-uuid-virtual-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", raw_to_uuid(signing_key) as "v" from project_release where id = :0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('view-boolean-virtual-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", case when (is_signed = 1) then 1 else 0 end as "v" from release_overview where id = :0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('view-boolean-virtual-optional', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", case when (is_signed = 1) then 1 when not (is_signed = 1) then 0 else null end as "v" from release_overview where id = :0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('view-uuid-virtual-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", raw_to_uuid(signing_uuid) as "v" from release_overview where id = :0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
