...
- [Insert](queries/insert.md#insert)
  ...
  - [Insert on confict do nothing](queries/insert.md#insert-on-confict-do-nothing)
  - [Insert on confict do update](queries/insert.md#insert-on-confict-do-update)
...
- [Insert](#insert)
  ...
  - [Insert on confict do nothing](#insert-on-confict-do-nothing)
  - [Insert on confict do update](#insert-on-confict-do-update)
