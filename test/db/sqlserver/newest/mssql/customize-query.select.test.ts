...
describe(ctx.label, () => {
    ...
    test('customize-recursive-select-hooks-render-in-inline-aggregated-array-value', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"with recursive_select_1 as /* warmup */ (select id as [result] from issue where id = @0 union all select issue.id as [result] from issue join recursive_select_1 on issue.parent_id = recursive_select_1.[result]) /* end-of-with */ select id as id, (/* head */  select /* hint */ /* cols */  json_arrayagg([result] null on null) from recursive_select_1  /* tail */) as tree from project where id = @1"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
            1,
    ...
    test('customize-recursive-one-column-custom-window-and-ordering-in-inline-aggregated-array-value', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"with recursive_select_1 as (select id as [result] from issue where id = @0 union all select issue.id as [result] from issue join recursive_select_1 on issue.parent_id = recursive_select_1.[result]) select id as id, (select json_arrayagg(a_2_.[result] null on null) from (select /* hint */ /* cols */  [result] as [result] from recursive_select_1 window w1 as (partition by result) order by [result] offset 0 rows) as a_2_) as tree from project where id = @1"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
            1,
    ...
    test('customize-recursive-one-column-ordering-in-inline-aggregated-array-value', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"with recursive_select_1 as (select id as [result] from issue where id = @0 union all select issue.id as [result] from issue join recursive_select_1 on issue.parent_id = recursive_select_1.[result]) select id as id, (select json_arrayagg(a_2_.[result] null on null) from (select [result] as [result] from recursive_select_1 order by [result] offset 0 rows) as a_2_) as tree from project where id = @1"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
            1,
