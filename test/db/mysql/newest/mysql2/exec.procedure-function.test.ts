...
describe(ctx.label, () => {
    ...
    test('execute-function-returning-boolean', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select ret_flag(?)"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('execute-function-returning-uuid', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select ret_uuid(?)"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('execute-function-returning-local-date', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select ret_day(?)"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('execute-function-returning-local-time', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select ret_clock(?)"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('execute-function-returning-enum', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select ret_activity(?)"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('execute-function-returning-custom', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select ret_channel(?)"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('execute-function-returning-custom-comparable', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select ret_semver(?)"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
