...
BEGIN EXECUTE IMMEDIATE 'DROP TABLE temporal_precision CASCADE CONSTRAINTS'; EXCEPTION WHEN OTHERS THEN NULL; END;
...
-- temporal_precision: a microsecond-precision localDateTime column (TIMESTAMP)
...
-- stay 999 (to_char(FF3), not a round up to 1000). Caller-provided int PK.
