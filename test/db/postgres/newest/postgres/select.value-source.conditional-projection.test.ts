...
describe(ctx.label, () => {
    ...
    test('onlyWhenOrNull-true-emits-column', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, priority as priority from issue where id = $1"`)
    ...
    test('onlyWhenOrNull-false-emits-null-literal', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, null::int4 as priority from issue where id = $1"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('onlyWhenOrNull-on-nullable-column-keeps-optional', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, body as body from issue where id in ($1, $2) order by id"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2,
            3,
    ...
    test('onlyWhenOrNull-composes-with-arithmetic', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, null::int4 as bumped from issue where id = $1"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('onlyWhenOrNull-true-with-arithmetic-emits-full-expression', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, priority + $1 as bumped from issue where id = $2"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
            1,
    ...
    test('onlyWhenOrNull-true-on-custom-boolean-carries-read-remap', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, (published = 't') as pub from project where id = $1"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('onlyWhenOrNull-false-on-custom-boolean-emits-null-literal', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, null::bool as pub from project where id = $1"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
