...
describe(ctx.label, () => {
    ...
    test('level-4-optional-container-default-as-undefined', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "iid", "number" as "a.keepA", title as "a.b.keepB", "body" as "a.b.c.body", assignee_id as "a.b.c.assigneeId" from issue where id in (:0, :1) order by "iid""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
            3,
    ...
    test('level-5-optional-container-default-as-undefined', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "iid", "number" as "a.keepA", title as "a.b.keepB", status as "a.b.c.keepC", "body" as "a.b.c.d.body", assignee_id as "a.b.c.d.assigneeId" from issue where id in (:0, :1) order by "iid""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
            3,
    ...
    test('level-4-rule1-gate-container-default-as-undefined', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "iid", "number" as "a.keepA", title as "a.b.keepB", status as "a.b.c.sibling", "body" as "a.b.c.gate" from issue where project_id = :0 order by "iid""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('level-5-rule1-gate-container-default-as-undefined', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "iid", "number" as "a.keepA", title as "a.b.keepB", status as "a.b.c.keepC", status as "a.b.c.d.sibling", "body" as "a.b.c.d.gate" from issue where project_id = :0 order by "iid""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
