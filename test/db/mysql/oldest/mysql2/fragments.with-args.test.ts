...
describe(ctx.label, () => {
    ...
    // TODO[LIMITATION]: see LIMITATIONS.md — MySQL 5.7 rejects a WHERE clause without a FROM (ER_PARSE_ERROR 1064); selectFromNoTable().where(...) emits `select … where …`, which MySQL 8.0+ accepts.
    /*
