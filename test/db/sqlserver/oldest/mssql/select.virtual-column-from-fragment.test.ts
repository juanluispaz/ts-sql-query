...
describe(ctx.label, () => {
    ...
    test('table-optional-virtual-column-and-adapter', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, upper(activity) as activityUpper, upper(activity) as activityTagged from issue_worklog where id = @0"`)
    ...
    test('view-optional-virtual-column', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, upper(version) as versionUpperOptional from release_overview where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2,
          ]
    ...
    test('aliased-view-virtual-column-re-qualifies-sibling-reference-under-alias', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select upper(po.name) as nameUpper from project_overview as po where po.id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('table-custom-int-virtual-column-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, id * 100 as cents from issue_worklog where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('table-custom-enum-virtual-column-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, lower(activity) as act from issue_worklog where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('view-custom-int-virtual-column-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, id * 10 as cents from release_overview where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2,
          ]
    ...
    test('worklog-boolean-virtual-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, cast(case when (billable = 1) then 1 else 0 end as bit) as [v] from issue_worklog where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('worklog-boolean-virtual-optional', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, cast(case when (billable = 1) then 1 when not (billable = 1) then 0 else null end as bit) as [v] from issue_worklog where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('worklog-bigint-virtual-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, id as [v] from issue_worklog where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('worklog-bigint-virtual-optional', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, duration_ms as [v] from issue_worklog where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('worklog-double-virtual-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, billed_amount as [v] from issue_worklog where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('worklog-local-date-virtual-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, work_date as [v] from issue_worklog where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('worklog-local-time-virtual-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, started_at as [v] from issue_worklog where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('worklog-int-virtual-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, id + 1 as [v] from issue_worklog where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('worklog-int-virtual-optional', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, minutes as [v] from issue_worklog where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('release-custom-comparable-virtual-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, version as [v] from project_release where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('release-custom-virtual-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, channel as [v] from project_release where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('release-custom-uuid-virtual-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, signing_key as [v] from project_release where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('release-custom-local-date-virtual-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, released_on as [v] from project_release where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('release-custom-local-time-virtual-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, cutoff_time as [v] from project_release where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('release-custom-local-date-time-virtual-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, published_at as [v] from project_release where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('release-custom-local-date-time-virtual-optional', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, signed_off_at as [v] from project_release where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('view-boolean-virtual-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, cast(case when (is_signed = 1) then 1 else 0 end as bit) as [v] from release_overview where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('view-boolean-virtual-optional', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, cast(case when (is_signed = 1) then 1 when not (is_signed = 1) then 0 else null end as bit) as [v] from release_overview where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('view-bigint-virtual-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, id as [v] from release_overview where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('view-bigint-virtual-optional', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, download_count as [v] from release_overview where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('view-double-virtual-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, avg_rating as [v] from release_overview where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('view-uuid-virtual-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, signing_uuid as [v] from release_overview where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('view-local-date-virtual-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, release_day_plain as [v] from release_overview where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('view-local-time-virtual-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, cutoff_plain as [v] from release_overview where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('view-local-date-time-virtual-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, published_stamp_plain as [v] from release_overview where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('view-local-date-time-virtual-optional', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, signed_off_at as [v] from release_overview where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('view-int-virtual-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, id + 1 as [v] from release_overview where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('view-custom-comparable-virtual-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, version as [v] from release_overview where id = @0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
