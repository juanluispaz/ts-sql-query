...
describe(ctx.label, () => {
    ...
    // TODO[LIMITATION]: see LIMITATIONS.md — MariaDB < 10.4 rejects a WHERE clause without a FROM (ER_PARSE_ERROR 1064); selectFromNoTable().where(...) emits `select … where …`, which MySQL and MariaDB 10.4+ accept.
    /*
