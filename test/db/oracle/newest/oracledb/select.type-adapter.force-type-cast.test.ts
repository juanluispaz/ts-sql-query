...
// PostgreSQL-specific by intent, so on Oracle the tests are kept
...
describe(ctx.label, () => {
    ...
    // NOT-APPLICABLE: Oracle — ForceTypeCast emits a PostgreSQL `::<type>` placeholder cast; other dialects no-op
    /*
