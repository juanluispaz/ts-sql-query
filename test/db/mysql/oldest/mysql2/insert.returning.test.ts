...
describe(ctx.label, () => {
    ...
    */
    ...
    // NOT-APPLICABLE: This dialect does not support INSERT ... RETURNING an object projection, so returning() is typed never here.
    /*
    ...
    */
    ...
    // NOT-APPLICABLE: MySQL has no RETURNING clause.
    /*
