...
describe(ctx.label, () => {
    ...
    test('bigint-equals-not-equals', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where duration_ms = :0 order by "id""`)
    ...
    test('bigint-is-is-not', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(duration_ms, :0, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            5400000n,
          ]
        ...
        const isNot = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(duration_ms, :0, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            5400000n,
          ]
    ...
    test('bigint-between-not-between', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where duration_ms between :0 and :1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1000000n,
            2000000n,
        ...
        const notRows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where duration_ms not between :0 and :1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1000000n,
            2000000n,
    ...
    test('bigint-in-array-in-n', async () => {
        ...
        const inRows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where duration_ms in (:0, :1) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            5400000n,
            1800000n,
        ...
        const inNRows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where duration_ms in (:0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            5400000n,
          ]
    ...
    test('bigint-in-subquery-not-in-subquery', async () => {
        ...
        const inRows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where duration_ms in (select duration_ms as "result" from issue_worklog where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
        ...
        const notInRows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where duration_ms not in (select duration_ms as "result" from issue_worklog where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('double-equals-not-equals', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            const rows = await ctx.conn.selectFrom(tIssue)
                ...
                .orderBy('id')
                .executeSelectMany()
            expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where estimated_hours = :0 order by "id""`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                2.5,
              ]
    ...
    test('double-is-is-not', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            const rows = await ctx.conn.selectFrom(tIssue)
                ...
                .orderBy('id')
                .executeSelectMany()
            expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where decode(estimated_hours, :0, 1, 0 ) = 1 order by "id""`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                2.5,
              ]
            ...
            const isNot = await ctx.conn.selectFrom(tIssue)
                ...
                .orderBy('id')
                .executeSelectMany()
            expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where decode(estimated_hours, :0, 1, 0 ) = 0 order by "id""`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                2.5,
              ]
    ...
    test('double-between-not-between', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            const rows = await ctx.conn.selectFrom(tIssue)
                ...
                .orderBy('id')
                .executeSelectMany()
            expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where estimated_hours between :0 and :1 order by "id""`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                2,
                5,
            ...
            const notRows = await ctx.conn.selectFrom(tIssue)
                ...
                .orderBy('id')
                .executeSelectMany()
            expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where estimated_hours not between :0 and :1 order by "id""`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                2,
                5,
    ...
    test('double-in-array-in-n', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            const inRows = await ctx.conn.selectFrom(tIssue)
                ...
                .orderBy('id')
                .executeSelectMany()
            expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where estimated_hours in (:0, :1) order by "id""`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                2.5,
                7.5,
            ...
            const inNRows = await ctx.conn.selectFrom(tIssue)
                ...
                .orderBy('id')
                .executeSelectMany()
            expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where estimated_hours in (:0) order by "id""`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                2.5,
              ]
    ...
    test('double-in-subquery-not-in-subquery', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            const inRows = await ctx.conn.selectFrom(tIssue)
                ...
                .orderBy('id')
                .executeSelectMany()
            expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where estimated_hours in (select estimated_hours as "result" from issue where id = :0) order by "id""`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                1,
              ]
            ...
            const notInRows = await ctx.conn.selectFrom(tIssue)
                ...
                .orderBy('id')
                .executeSelectMany()
            expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where estimated_hours not in (select estimated_hours as "result" from issue where id = :0) order by "id""`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                1,
              ]
    ...
    test('customInt-equals-not-equals', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where cost_cents = :0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            400,
          ]
    ...
    test('customInt-is-is-not', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(cost_cents, :0, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            400,
          ]
        ...
        const isNot = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(cost_cents, :0, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            400,
          ]
    ...
    test('customInt-between-not-between', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where cost_cents between :0 and :1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            50,
            200,
        ...
        const notRows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where cost_cents not between :0 and :1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            50,
            200,
    ...
    test('customInt-in-array-in-n', async () => {
        ...
        const inRows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where cost_cents in (:0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            400,
          ]
    ...
    test('customInt-in-subquery-not-in-subquery', async () => {
        ...
        const inRows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where cost_cents in (select cost_cents as "result" from issue_worklog where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            3,
          ]
        ...
        const notInRows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where cost_cents not in (select cost_cents as "result" from issue_worklog where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            3,
          ]
    ...
    test('customDouble-is-is-not', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(billed_amount, :0, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            50,
          ]
        ...
        const isNot = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(billed_amount, :0, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            50,
          ]
    ...
    test('customDouble-between-not-between', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where billed_amount between :0 and :1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            100,
            300,
        ...
        const notRows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where billed_amount not between :0 and :1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            100,
            300,
    ...
    test('customDouble-in-array-in-n', async () => {
        ...
        const inRows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where billed_amount in (:0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            50,
          ]
    ...
    test('uuid-equals-not-equals', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where external_ref = uuid_to_raw(:0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
    ...
    test('uuid-is-is-not', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where decode(external_ref, uuid_to_raw(:0), 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "0a8f9c1e-1111-4222-8333-444455556666",
          ]
        ...
        const isNot = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where decode(external_ref, uuid_to_raw(:0), 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "0a8f9c1e-1111-4222-8333-444455556666",
          ]
    ...
    // NOT-APPLICABLE: Oracle compares `external_ref between uuid_to_raw(...)` without
    // normalizing the column to the dashless-RAW form `equals` uses, so the byte-range
    // bounds never bracket the dashed-string ref — uuid range comparison is not portable.
    /*
    test('uuid-between-not-between', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where external_ref between uuid_to_raw(:0) and uuid_to_raw(:1) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
        ...
        const notRows = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where external_ref not between uuid_to_raw(:0) and uuid_to_raw(:1) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "00000000-0000-0000-0000-000000000000",
            "50000000-0000-0000-0000-000000000000",
    ...
    */
    ...
    test('uuid-in-array-in-n', async () => {
        ...
        const inRows = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where external_ref in (uuid_to_raw(:0), uuid_to_raw(:1)) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "0a8f9c1e-1111-4222-8333-444455556666",
        ...
        const inNRows = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where external_ref in (uuid_to_raw(:0)) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "0a8f9c1e-1111-4222-8333-444455556666",
          ]
    ...
    test('uuid-in-subquery-not-in-subquery', async () => {
        ...
        const inRows = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where external_ref in (select external_ref as "result" from issue where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
        ...
        const notInRows = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where external_ref not in (select external_ref as "result" from issue where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('customUuid-in-subquery-not-in-subquery', async () => {
        ...
        const inRows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where signing_key in (select signing_key as "result" from project_release where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
        ...
        const notInRows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where signing_key not in (select signing_key as "result" from project_release where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('customComparable-is-is-not', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(version, :0, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "1.2.0",
          ]
        ...
        const isNot = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(version, :0, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "1.2.0",
          ]
    ...
    test('customComparable-in-subquery-not-in-subquery', async () => {
        ...
        const inRows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where version in (select version as "result" from project_release where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
        ...
        const notInRows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where version not in (select version as "result" from project_release where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('custom-is-is-not', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(channel, :0, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "stable",
          ]
        ...
        const isNot = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(channel, :0, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "stable",
          ]
    ...
    test('numeric-custom-boolean-direct-filter-operand', async () => {
        ...
        const eqRows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where case when invoiced = 1 then 1 else 0 end = :0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
        ...
        const isRows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(case when invoiced = 1 then 1 else 0 end, :0, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
        ...
        const inRows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where case when invoiced = 1 then 1 else 0 end in (:0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            0,
          ]
    ...
    test('customUuid-is-is-not-and-value-source-operand', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(signing_key, uuid_to_raw(:0), 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "0a8f9c1e-1111-4222-8333-444455556666",
          ]
        ...
        const isNot = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(signing_key, uuid_to_raw(:0), 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "0a8f9c1e-1111-4222-8333-444455556666",
          ]
    ...
    test('string-ordered-comparison-and-between', async () => {
        ...
        const lt = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where title < :0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "Migrate to ESM",
          ]
        ...
        const between = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where title between :0 and :1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "Migrate to ESM",
            "Redesign navbar",
    ...
    test('customComparable-greater-or-equal-and-not-between', async () => {
        ...
        const notRows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where version not between :0 and :1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "1.0.0",
            "1.2.5",
    ...
    // NOT-APPLICABLE: Oracle compares `external_ref < uuid_to_raw(...)` against a
    // dashless-RAW bound the dashed-string column is never normalized to, so uuid range
    // comparison is not portable here (same reason as uuid-between-not-between above).
    /*
    ...
    */
    ...
    test('customDouble-in-subquery-not-in-subquery', async () => {
        ...
        const inRows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where billed_amount in (select billed_amount as "result" from issue_worklog where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2,
          ]
        ...
        const notInRows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where billed_amount not in (select billed_amount as "result" from issue_worklog where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2,
          ]
    ...
    test('localDateTime-equals-not-equals', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tOrganization)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from "organization" where created_at = :0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
    ...
    test('localDateTime-is-is-not', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tOrganization)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from "organization" where decode(created_at, :0, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2023-06-15T08:00:00.000Z,
          ]
        ...
        const isNot = await ctx.conn.selectFrom(tOrganization)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from "organization" where decode(created_at, :0, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2023-06-15T08:00:00.000Z,
          ]
    ...
    test('localDateTime-in-array-in-n', async () => {
        ...
        const inRows = await ctx.conn.selectFrom(tOrganization)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from "organization" where created_at in (:0, :1) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2023-06-15T08:00:00.000Z,
        ...
        const inNRows = await ctx.conn.selectFrom(tOrganization)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from "organization" where created_at in (:0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2023-06-15T08:00:00.000Z,
          ]
    ...
    test('localDateTime-between-not-between', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tOrganization)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from "organization" where created_at between :0 and :1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
        ...
        const notRows = await ctx.conn.selectFrom(tOrganization)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from "organization" where created_at not between :0 and :1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2023-01-01T00:00:00.000Z,
            2023-07-01T00:00:00.000Z,
    ...
    test('required-customLocalDateTime-equalable-comparable-surface', async () => {
        ...
        const eq = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where published_at = :0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
        ...
        const is = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(published_at, :0, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2024-01-16T09:00:00.000Z,
          ]
        ...
        const between = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where published_at between :0 and :1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
        ...
        const inRows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where published_at in (:0, :1) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2024-01-16T09:00:00.000Z,
    ...
    test('required-localTime-equalable-comparable-surface', async () => {
        ...
        const eq = await ctx.conn.selectFrom(tProjectReview)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_review where review_time = :0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1970-01-01T14:30:45.000Z,
          ]
        `)
        assertType<Exact<typeof eq, Array<{ id: number }>>>()
        expect(eq).toEqual(expectedEq)
        ...
        const is = await ctx.conn.selectFrom(tProjectReview)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_review where decode(review_time, :0, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1970-01-01T14:30:45.000Z,
          ]
        ...
        const between = await ctx.conn.selectFrom(tProjectReview)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_review where review_time between :0 and :1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
        ...
        const inRows = await ctx.conn.selectFrom(tProjectReview)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_review where review_time in (:0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1970-01-01T14:30:45.000Z,
          ]
    ...
    test('bigint-between-mixed-overloads-and-column-operand', async () => {
        ...
        const cv = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where duration_ms between :0 and (select duration_ms as "result" from issue_worklog where id = :1) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1800000n,
            1,
        ...
        const vc = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where duration_ms between (select duration_ms as "result" from issue_worklog where id = :0) and :1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            3,
            5400000n,
        ...
        const vv = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where duration_ms between (select duration_ms as "result" from issue_worklog where id = :0) and (select duration_ms as "result" from issue_worklog where id = :1) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            3,
            1,
        ...
        const gt = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where duration_ms > (select duration_ms as "result" from issue_worklog where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            3,
          ]
    ...
    test('customLocalDateTime-is-if-value-is-not-if-value-fires-and-elides', async () => {
        ...
        const isIf = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(signed_off_at, :0, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
        ...
        const isNotIf = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(signed_off_at, :0, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2024-01-14T12:30:00.000Z,
          ]
    ...
    test('uuid-not-equals-if-value-not-in-if-value-fires-and-elides', async () => {
        ...
        const notInIf = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where external_ref not in (uuid_to_raw(:0)) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "0a8f9c1e-1111-4222-8333-444455556666",
          ]
    ...
    test('bigint-in-n-mixed-const-and-value-source', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where duration_ms in (:0, (select duration_ms as "result" from issue_worklog where id = :1)) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1800000n,
            1,
    ...
    test('string-is-is-not-const', async () => {
        ...
        const is = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where decode(title, :0, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "Migrate to ESM",
          ]
        ...
        const isNot = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where decode(title, :0, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "Migrate to ESM",
          ]
    ...
    test('customLocalDateTime-equals-not-equals-value-source-operand', async () => {
        ...
        const eq = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where signed_off_at = (select signed_off_at as "result" from project_release where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('is-value-source-operand-enum-custom-customUuid', async () => {
        ...
        const enumRows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(activity, activity, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        ...
        const customRows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(channel, channel, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        ...
        const customUuidRows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(signing_key, signing_key, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
    ...
    test('customInt-ordered-comparison-and-mixed-between-value-source-operand', async () => {
        ...
        const gt = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where cost_cents > (select cost_cents as "result" from issue_worklog where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
        ...
        const cv = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where cost_cents between :0 and (select cost_cents as "result" from issue_worklog where id = :1) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            100,
            3,
        ...
        const vc = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where cost_cents between (select cost_cents as "result" from issue_worklog where id = :0) and :1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
            400,
        ...
        const vv = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where cost_cents between (select cost_cents as "result" from issue_worklog where id = :0) and (select cost_cents as "result" from issue_worklog where id = :1) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
            3,
    ...
    test('uuid-ordered-comparison-and-mixed-between-value-source-operand', async () => {
        ...
        const gt = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where external_ref > (select external_ref as "result" from issue where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
        ...
        const cv = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where external_ref between uuid_to_raw(:0) and (select external_ref as "result" from issue where id = :1) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "0a8f9c1e-1111-4222-8333-444455556666",
            2,
        ...
        const vc = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where external_ref between (select external_ref as "result" from issue where id = :0) and uuid_to_raw(:1) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
            "7b3e9d20-2222-4c55-9b66-dddd00009999",
        ...
        const vv = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where external_ref between (select external_ref as "result" from issue where id = :0) and (select external_ref as "result" from issue where id = :1) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
            2,
    ...
    test('customComparable-ordered-comparison-value-source-operand', async () => {
        ...
        const ge = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where version >= (select version as "result" from project_release where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('customLocalDateTime-ordered-comparison-value-source-operand', async () => {
        ...
        const gt = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where published_at > (select published_at as "result" from project_release where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2,
          ]
    ...
    test('double-ordered-comparison-value-source-operand', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            const gt = await ctx.conn.selectFrom(tIssue)
                ...
                .orderBy('id')
                .executeSelectMany()
            expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where estimated_hours > (select estimated_hours as "result" from issue where id = :0) order by "id""`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                1,
              ]
    ...
    test('numeric-custom-equals-value-source-operand', async () => {
        ...
        const billedRows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where billed_amount = (select billed_amount as "result" from issue_worklog where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2,
          ]
    ...
    test('plain-boolean-is-not-and-is-not-null', async () => {
        ...
        const isNot = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(billable, :0, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('boolean-not-in-array-in-n-not-in-n', async () => {
        ...
        const notInRows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where billable not in (:0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            0,
          ]
        ...
        const inNRows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where billable in (:0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            0,
          ]
    ...
    test('localDate-in-subquery-not-in-subquery', async () => {
        ...
        const inRows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where work_date in (select work_date as "result" from issue_worklog where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2,
          ]
        ...
        const notInRows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where work_date not in (select work_date as "result" from issue_worklog where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2,
          ]
    ...
    test('localTime-in-subquery-not-in-subquery', async () => {
        ...
        const inRows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where started_at in (select started_at as "result" from issue_worklog where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2,
          ]
        ...
        const notInRows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where started_at not in (select started_at as "result" from issue_worklog where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2,
          ]
    ...
    test('localDateTime-in-subquery-not-in-subquery', async () => {
        ...
        const inRows = await ctx.conn.selectFrom(tOrganization)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from "organization" where created_at in (select created_at as "result" from "organization" where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
        ...
        const notInRows = await ctx.conn.selectFrom(tOrganization)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from "organization" where created_at not in (select created_at as "result" from "organization" where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('customLocalDate-in-subquery-not-in-subquery', async () => {
        ...
        const inRows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where released_on in (select released_on as "result" from project_release where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
        ...
        const notInRows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where released_on not in (select released_on as "result" from project_release where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('customLocalTime-in-subquery-not-in-subquery', async () => {
        ...
        const inRows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where cutoff_time in (select cutoff_time as "result" from project_release where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
        ...
        const notInRows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where cutoff_time not in (select cutoff_time as "result" from project_release where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('customLocalDateTime-in-subquery-not-in-subquery', async () => {
        ...
        const inRows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where published_at in (select published_at as "result" from project_release where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
        ...
        const notInRows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where published_at not in (select published_at as "result" from project_release where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('bigint-equals-not-equals-is-is-not-value-source-operand', async () => {
        ...
        const is = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(duration_ms, (select duration_ms as "result" from issue_worklog where id = :0), 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
        ...
        const isNot = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(duration_ms, (select duration_ms as "result" from issue_worklog where id = :0), 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('string-equals-not-equals-is-is-not-value-source-operand', async () => {
        ...
        const eq = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where title = (select title as "result" from issue where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            3,
          ]
        ...
        const is = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where decode(title, (select title as "result" from issue where id = :0), 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            3,
          ]
        ...
        const isNot = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where decode(title, (select title as "result" from issue where id = :0), 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            3,
          ]
    ...
    test('double-equals-not-equals-is-is-not-value-source-operand', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            const is = await ctx.conn.selectFrom(tIssue)
                ...
                .orderBy('id')
                .executeSelectMany()
            expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where decode(estimated_hours, (select estimated_hours as "result" from issue where id = :0), 1, 0 ) = 1 order by "id""`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                1,
              ]
            ...
            const isNot = await ctx.conn.selectFrom(tIssue)
                ...
                .orderBy('id')
                .executeSelectMany()
            expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where decode(estimated_hours, (select estimated_hours as "result" from issue where id = :0), 1, 0 ) = 0 order by "id""`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                1,
              ]
    ...
    test('localDate-equals-not-equals-is-is-not-value-source-operand', async () => {
        ...
        const eq = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where work_date = (select work_date as "result" from issue_worklog where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2,
          ]
        ...
        const is = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(work_date, (select work_date as "result" from issue_worklog where id = :0), 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2,
          ]
        ...
        const isNot = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(work_date, (select work_date as "result" from issue_worklog where id = :0), 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2,
          ]
    ...
    test('localTime-equals-not-equals-is-is-not-value-source-operand', async () => {
        ...
        const eq = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where started_at = (select started_at as "result" from issue_worklog where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2,
          ]
        ...
        const is = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(started_at, (select started_at as "result" from issue_worklog where id = :0), 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2,
          ]
        ...
        const isNot = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(started_at, (select started_at as "result" from issue_worklog where id = :0), 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2,
          ]
    ...
    test('localDateTime-equals-not-equals-is-is-not-value-source-operand', async () => {
        ...
        const eq = await ctx.conn.selectFrom(tOrganization)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from "organization" where created_at = (select created_at as "result" from "organization" where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
        ...
        const is = await ctx.conn.selectFrom(tOrganization)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from "organization" where decode(created_at, (select created_at as "result" from "organization" where id = :0), 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
        ...
        const isNot = await ctx.conn.selectFrom(tOrganization)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from "organization" where decode(created_at, (select created_at as "result" from "organization" where id = :0), 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('customInt-not-equals-is-is-not-value-source-operand', async () => {
        ...
        const is = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(cost_cents, (select cost_cents as "result" from issue_worklog where id = :0), 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            3,
          ]
        ...
        const isNot = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(cost_cents, (select cost_cents as "result" from issue_worklog where id = :0), 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            3,
          ]
    ...
    test('customLocalTime-equals-not-equals-is-is-not-value-source-operand', async () => {
        ...
        const eq = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where cutoff_time = (select cutoff_time as "result" from project_release where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
        ...
        const is = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(cutoff_time, (select cutoff_time as "result" from project_release where id = :0), 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
        ...
        const isNot = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(cutoff_time, (select cutoff_time as "result" from project_release where id = :0), 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('string-not-between-const', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where title not between :0 and :1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "Document /v2/users",
            "Migrate to ESM",
    ...
    test('string-in-array', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where title in (:0, :1) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "Update hero copy",
            "Redesign navbar",
    ...
    test('string-in-n', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where title in (:0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "Update hero copy",
          ]
    ...
    test('string-not-in-array', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where title not in (:0, :1) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "Migrate to ESM",
            "Document /v2/users",
    ...
    test('bigint-not-in-n', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where duration_ms not in (:0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            5400000n,
          ]
    ...
    test('double-not-in-n', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            const rows = await ctx.conn.selectFrom(tIssue)
                ...
                .orderBy('id')
                .executeSelectMany()
            expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where estimated_hours not in (:0) order by "id""`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                2.5,
              ]
    ...
    test('customInt-not-in-n', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where cost_cents not in (:0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            100,
          ]
    ...
    test('customDouble-not-in-n', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where billed_amount not in (:0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            200,
          ]
    ...
    test('string-not-in-n', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where title not in (:0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "Migrate to ESM",
          ]
    ...
    test('customUuid-not-in-n', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where signing_key not in (uuid_to_raw(:0)) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "0a8f9c1e-1111-4222-8333-444455556666",
          ]
    ...
    test('localDate-not-in-n', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where work_date not in (:0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
    ...
    test('localTime-not-in-n', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where started_at not in (:0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
    ...
    test('localDateTime-not-in-n', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where created_at not in (:0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2000-01-01T00:00:00.000Z,
          ]
    ...
    test('customLocalDateTime-not-in-n', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where signed_off_at not in (:0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2024-01-14T12:30:00.000Z,
          ]
    ...
    test('customUuid-in-n', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where signing_key in (uuid_to_raw(:0)) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "0a8f9c1e-1111-4222-8333-444455556666",
          ]
    ...
    test('customComparable-in-n', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where version in (:0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "1.2.0",
          ]
    ...
    test('bigint-column-operand-comparable-membership', async () => {
        ...
        const is = await ctx.conn.selectFrom(tIssueWorklog).where(c.is(c))
            .select({ id: tIssueWorklog.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(duration_ms, duration_ms, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        ...
        const isNot = await ctx.conn.selectFrom(tIssueWorklog).where(c.isNot(c))
            .select({ id: tIssueWorklog.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(duration_ms, duration_ms, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
    ...
    test('customInt-column-operand-comparable-membership', async () => {
        ...
        const is = await ctx.conn.selectFrom(tIssueWorklog).where(c.is(c))
            .select({ id: tIssueWorklog.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(cost_cents, cost_cents, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        expect(is).toEqual(all)
        ...
        const isNot = await ctx.conn.selectFrom(tIssueWorklog).where(c.isNot(c))
            .select({ id: tIssueWorklog.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(cost_cents, cost_cents, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        expect(isNot).toEqual(none)
    ...
    test('customDouble-column-operand-comparable-membership', async () => {
        ...
        const isv = await ctx.conn.selectFrom(tIssueWorklog).where(c.is(c))
            .select({ id: tIssueWorklog.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(billed_amount, billed_amount, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        ...
        const isNot = await ctx.conn.selectFrom(tIssueWorklog).where(c.isNot(c))
            .select({ id: tIssueWorklog.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(billed_amount, billed_amount, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        expect(isNot).toEqual(none)
    ...
    test('localDate-column-operand-comparable-membership', async () => {
        ...
        const isv = await ctx.conn.selectFrom(tIssueWorklog).where(c.is(c))
            .select({ id: tIssueWorklog.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(work_date, work_date, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        expect(isv).toEqual(all)
        ...
        const isNot = await ctx.conn.selectFrom(tIssueWorklog).where(c.isNot(c))
            .select({ id: tIssueWorklog.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(work_date, work_date, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        expect(isNot).toEqual(none)
    ...
    test('localTime-column-operand-comparable-membership', async () => {
        ...
        const isv = await ctx.conn.selectFrom(tIssueWorklog).where(c.is(c))
            .select({ id: tIssueWorklog.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(started_at, started_at, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        expect(isv).toEqual(all)
        ...
        const isNot = await ctx.conn.selectFrom(tIssueWorklog).where(c.isNot(c))
            .select({ id: tIssueWorklog.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(started_at, started_at, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        expect(isNot).toEqual(none)
    ...
    test('customComparable-column-operand-comparable-membership', async () => {
        ...
        const isv = await ctx.conn.selectFrom(tProjectRelease).where(c.is(c))
            .select({ id: tProjectRelease.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(version, version, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        expect(isv).toEqual(all)
        ...
        const isNot = await ctx.conn.selectFrom(tProjectRelease).where(c.isNot(c))
            .select({ id: tProjectRelease.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(version, version, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        expect(isNot).toEqual(none)
    ...
    test('customLocalTime-column-operand-comparable-membership', async () => {
        ...
        const isv = await ctx.conn.selectFrom(tProjectRelease).where(c.is(c))
            .select({ id: tProjectRelease.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(cutoff_time, cutoff_time, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        expect(isv).toEqual(all)
        ...
        const isNot = await ctx.conn.selectFrom(tProjectRelease).where(c.isNot(c))
            .select({ id: tProjectRelease.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(cutoff_time, cutoff_time, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        expect(isNot).toEqual(none)
    ...
    test('customLocalDate-column-operand-comparable-membership', async () => {
        ...
        const isv = await ctx.conn.selectFrom(tProjectRelease).where(c.is(c))
            .select({ id: tProjectRelease.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(released_on, released_on, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        expect(isv).toEqual(all)
        ...
        const isNot = await ctx.conn.selectFrom(tProjectRelease).where(c.isNot(c))
            .select({ id: tProjectRelease.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(released_on, released_on, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        expect(isNot).toEqual(none)
    ...
    test('customLocalDateTime-column-operand-comparable-membership', async () => {
        ...
        const isv = await ctx.conn.selectFrom(tProjectRelease).where(c.is(c))
            .select({ id: tProjectRelease.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(signed_off_at, signed_off_at, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        expect(isv).toEqual(all)
        ...
        const isNot = await ctx.conn.selectFrom(tProjectRelease).where(c.isNot(c))
            .select({ id: tProjectRelease.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(signed_off_at, signed_off_at, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        expect(isNot).toEqual(none)
    ...
    test('localDateTime-column-operand-comparable-membership', async () => {
        ...
        const isv = await ctx.conn.selectFrom(tOrganization).where(c.is(c))
            .select({ id: tOrganization.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from "organization" where decode(created_at, created_at, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        expect(isv).toEqual(all)
        ...
        const isNot = await ctx.conn.selectFrom(tOrganization).where(c.isNot(c))
            .select({ id: tOrganization.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from "organization" where decode(created_at, created_at, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        expect(isNot).toEqual(none)
    ...
    test('uuid-column-operand-comparable-membership', async () => {
        ...
        const isv = await ctx.conn.selectFrom(tIssue).where(c.is(c))
            .select({ id: tIssue.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where decode(external_ref, external_ref, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        expect(isv).toEqual(all)
        ...
        const isNot = await ctx.conn.selectFrom(tIssue).where(c.isNot(c))
            .select({ id: tIssue.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where decode(external_ref, external_ref, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        expect(isNot).toEqual(none)
    ...
    test('string-column-operand-comparable-membership', async () => {
        ...
        const isv = await ctx.conn.selectFrom(tIssue).where(c.is(c))
            .select({ id: tIssue.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where decode(title, title, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        expect(isv).toEqual(all)
        ...
        const isNot = await ctx.conn.selectFrom(tIssue).where(c.isNot(c))
            .select({ id: tIssue.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where decode(title, title, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        expect(isNot).toEqual(none)
    ...
    test('customUuid-column-operand-comparable-membership', async () => {
        ...
        const isNot = await ctx.conn.selectFrom(tProjectRelease).where(c.isNot(c))
            .select({ id: tProjectRelease.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(signing_key, signing_key, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        expect(isNot).toEqual(none)
    ...
    test('custom-column-operand-equality-membership', async () => {
        ...
        const isNot = await ctx.conn.selectFrom(tProjectRelease).where(c.isNot(c))
            .select({ id: tProjectRelease.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(channel, channel, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        expect(isNot).toEqual(none)
    ...
    test('enum-column-operand-equality-membership', async () => {
        ...
        const isNot = await ctx.conn.selectFrom(tIssueWorklog).where(c.isNot(c))
            .select({ id: tIssueWorklog.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(activity, activity, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        expect(isNot).toEqual(none)
    ...
    test('boolean-column-operand-equality-membership', async () => {
        ...
        const isv = await ctx.conn.selectFrom(tIssueWorklog).where(c.is(c))
            .select({ id: tIssueWorklog.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(billable, billable, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        expect(isv).toEqual(all)
        ...
        const isNot = await ctx.conn.selectFrom(tIssueWorklog).where(c.isNot(c))
            .select({ id: tIssueWorklog.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(billable, billable, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        expect(isNot).toEqual(none)
    ...
    test('boolean-value-when-null-nullif-value-column-arg', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", nvl(billable, billable) as "b" from issue_worklog order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
    ...
    test('uuid-nullif-value-column-arg', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", raw_to_uuid(nullif(external_ref, external_ref)) as "ref" from issue order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
    ...
    test('customComparable-value-when-null-nullif-value-column-arg', async () => {
        ...
        const vwnRows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", nvl(version, version) as "v" from project_release order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
    ...
    test('localDate-if-value-twins-fires-and-elides', async () => {
        ...
        const isF = await ctx.conn.selectFrom(tIssueWorklog).where(tIssueWorklog.workDate.isIfValue(d))
            .select({ id: tIssueWorklog.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(work_date, :0, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2024-03-05T00:00:00.000Z,
          ]
        ...
        const isNotF = await ctx.conn.selectFrom(tIssueWorklog).where(tIssueWorklog.workDate.isNotIfValue(d))
            .select({ id: tIssueWorklog.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(work_date, :0, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2024-03-05T00:00:00.000Z,
          ]
        ...
        const inF = await ctx.conn.selectFrom(tIssueWorklog).where(tIssueWorklog.workDate.inIfValue([d]))
            .select({ id: tIssueWorklog.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where work_date in (:0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2024-03-05T00:00:00.000Z,
          ]
    ...
    test('localTime-if-value-twins-fires-and-elides', async () => {
        ...
        const isF = await ctx.conn.selectFrom(tIssueWorklog).where(tIssueWorklog.startedAt.isIfValue(t))
            .select({ id: tIssueWorklog.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(started_at, :0, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1970-01-01T10:30:00.000Z,
          ]
        ...
        const isNotF = await ctx.conn.selectFrom(tIssueWorklog).where(tIssueWorklog.startedAt.isNotIfValue(t))
            .select({ id: tIssueWorklog.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(started_at, :0, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1970-01-01T10:30:00.000Z,
          ]
        ...
        const inF = await ctx.conn.selectFrom(tIssueWorklog).where(tIssueWorklog.startedAt.inIfValue([t]))
            .select({ id: tIssueWorklog.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where started_at in (:0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1970-01-01T10:30:00.000Z,
          ]
    ...
    test('localDateTime-if-value-twins-fires-and-elides', async () => {
        ...
        const notInF = await ctx.conn.selectFrom(tOrganization).where(tOrganization.createdAt.notInIfValue([ts]))
            .select({ id: tOrganization.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from "organization" where created_at not in (:0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2023-06-15T08:00:00.000Z,
          ]
    ...
    test('customComparable-if-value-twins-fires-and-elides', async () => {
        ...
        const notInF = await ctx.conn.selectFrom(tProjectRelease).where(tProjectRelease.version.notInIfValue([sv]))
            .select({ id: tProjectRelease.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where version not in (:0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "1.2.0",
          ]
    ...
    test('enum-is-if-value-is-not-if-value-fires-and-elides', async () => {
        ...
        const isF = await ctx.conn.selectFrom(tIssueWorklog).where(tIssueWorklog.activity.isIfValue('coding'))
            .select({ id: tIssueWorklog.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(activity, :0, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "coding",
          ]
        ...
        const isNotF = await ctx.conn.selectFrom(tIssueWorklog).where(tIssueWorklog.activity.isNotIfValue('coding'))
            .select({ id: tIssueWorklog.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(activity, :0, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "coding",
          ]
    ...
    test('customUuid-if-value-twins-fires-and-elides', async () => {
        ...
        const notEqualsF = await ctx.conn.selectFrom(tProjectRelease).where(tProjectRelease.signingKey.notEqualsIfValue(key))
            .select({ id: tProjectRelease.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where signing_key <> uuid_to_raw(:0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "0a8f9c1e-1111-4222-8333-444455556666",
          ]
    ...
    test('customLocalTime-is-if-value-is-not-if-value-fires-and-elides', async () => {
        ...
        const isF = await ctx.conn.selectFrom(tProjectRelease).where(tProjectRelease.cutoffTime.isIfValue(ct))
            .select({ id: tProjectRelease.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(cutoff_time, :0, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
        ...
        const isNotF = await ctx.conn.selectFrom(tProjectRelease).where(tProjectRelease.cutoffTime.isNotIfValue(ct))
            .select({ id: tProjectRelease.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(cutoff_time, :0, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1970-01-01T17:00:00.000Z,
          ]
    ...
    test('string-in-subquery-not-in-subquery', async () => {
        ...
        const inRows = await ctx.conn.selectFrom(tIssue).where(tIssue.title.in(titlesSub))
            .select({ id: tIssue.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where title in (select title as "result" from issue where id in (:0, :1)) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
            2,
        ...
        const notRows = await ctx.conn.selectFrom(tIssue).where(tIssue.title.notIn(titlesSub))
            .select({ id: tIssue.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where title not in (select title as "result" from issue where id in (:0, :1)) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
            2,
    ...
    test('boolean-in-subquery-not-in-subquery', async () => {
        ...
        const inRows = await ctx.conn.selectFrom(tIssueWorklog).where(tIssueWorklog.billable.in(billableSub))
            .select({ id: tIssueWorklog.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where billable in (select billable as "result" from issue_worklog where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
        ...
        const notRows = await ctx.conn.selectFrom(tIssueWorklog).where(tIssueWorklog.billable.notIn(billableSub))
            .select({ id: tIssueWorklog.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where billable not in (select billable as "result" from issue_worklog where id = :0) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('localTime-in-n-multi-const', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssueWorklog).where(tIssueWorklog.startedAt.inN(t1, t3))
            .select({ id: tIssueWorklog.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where started_at in (:0, :1) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1970-01-01T09:15:00.000Z,
            1970-01-01T10:30:00.000Z,
    ...
    test('double-column-operand-comparable-membership', async () => {
        ...
        const is = await ctx.conn.selectFrom(tIssue).where(c.is(c))
            .select({ id: tIssue.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where decode(estimated_hours, estimated_hours, 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        expect(is).toEqual(all)
        ...
        const isNot = await ctx.conn.selectFrom(tIssue).where(c.isNot(c))
            .select({ id: tIssue.id }).orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where decode(estimated_hours, estimated_hours, 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        expect(isNot).toEqual(none)
    ...
    test('double-value-when-null-nullif-value-column-arg', async () => {
        ...
        const vwnRows = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", nvl(estimated_hours, estimated_hours) as "h" from issue order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
    ...
    test('customUuid-nullif-value-column-arg', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id').executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", raw_to_uuid(nullif(signing_key, signing_key)) as "k" from project_release order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
    ...
    test('boolean-is-is-not-value-source-operand', async () => {
        ...
        const is = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(billable, (select billable as "result" from issue_worklog where id = :0), 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
        ...
        const isNot = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(billable, (select billable as "result" from issue_worklog where id = :0), 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('uuid-is-is-not-value-source-operand', async () => {
        ...
        const is = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where decode(external_ref, (select external_ref as "result" from issue where id = :0), 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
        ...
        const isNot = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where decode(external_ref, (select external_ref as "result" from issue where id = :0), 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('customDouble-is-is-not-value-source-operand', async () => {
        ...
        const is = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(billed_amount, (select billed_amount as "result" from issue_worklog where id = :0), 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2,
          ]
        ...
        const isNot = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where decode(billed_amount, (select billed_amount as "result" from issue_worklog where id = :0), 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2,
          ]
    ...
    test('customComparable-is-is-not-value-source-operand', async () => {
        ...
        const is = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(version, (select version as "result" from project_release where id = :0), 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
        ...
        const isNot = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(version, (select version as "result" from project_release where id = :0), 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('customLocalDateTime-is-is-not-value-source-operand', async () => {
        ...
        const is = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(signed_off_at, (select signed_off_at as "result" from project_release where id = :0), 1, 0 ) = 1 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
        ...
        const isNot = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where decode(signed_off_at, (select signed_off_at as "result" from project_release where id = :0), 1, 0 ) = 0 order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('int-in-n-mixed-const-and-value-source', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where priority in (:0, (select priority as "result" from issue where id = :1)) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
            3,
    ...
    test('double-in-n-mixed-const-and-value-source', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            const rows = await ctx.conn.selectFrom(tIssue)
                ...
                .orderBy('id')
                .executeSelectMany()
            expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where estimated_hours in (:0, (select estimated_hours as "result" from issue where id = :1)) order by "id""`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                7.5,
                1,
    ...
    test('string-in-n-mixed-const-and-value-source', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where title in (:0, (select title as "result" from issue where id = :1)) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "Update hero copy",
            3,
    ...
    test('uuid-in-n-mixed-const-and-value-source', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue where external_ref in (uuid_to_raw(:0), (select external_ref as "result" from issue where id = :1)) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "7b3e9d20-2222-4c55-9b66-dddd00009999",
            1,
    ...
    test('localDate-in-n-mixed-const-and-value-source', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where work_date in (:0, (select work_date as "result" from issue_worklog where id = :1)) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2024-03-04T00:00:00.000Z,
            3,
    ...
    test('localTime-in-n-mixed-const-and-value-source', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where started_at in (:0, (select started_at as "result" from issue_worklog where id = :1)) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1970-01-01T09:15:00.000Z,
            3,
    ...
    test('localDateTime-in-n-mixed-const-and-value-source', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tOrganization)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from "organization" where created_at in (:0, (select created_at as "result" from "organization" where id = :1)) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2023-06-15T08:00:00.000Z,
            2,
    ...
    test('customInt-in-n-mixed-const-and-value-source', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where cost_cents in (:0, (select cost_cents as "result" from issue_worklog where id = :1)) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            400,
            1,
    ...
    test('customDouble-in-n-mixed-const-and-value-source', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where billed_amount in (:0, (select billed_amount as "result" from issue_worklog where id = :1)) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            200,
            2,
    ...
    test('customComparable-in-n-mixed-const-and-value-source', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where version in (:0, (select version as "result" from project_release where id = :1)) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "1.2.0",
            3,
    ...
    test('custom-in-n-mixed-const-and-value-source', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where channel in (:0, (select channel as "result" from project_release where id = :1)) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "stable",
            3,
    ...
    test('enum-in-n-mixed-const-and-value-source', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where activity in (:0, (select activity as "result" from issue_worklog where id = :1)) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "coding",
            3,
    ...
    test('customUuid-in-n-mixed-const-and-value-source', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where signing_key in (uuid_to_raw(:0), (select signing_key as "result" from project_release where id = :1)) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "0a8f9c1e-1111-4222-8333-444455556666",
            3,
    ...
    test('customLocalDate-in-n-mixed-const-and-value-source', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where released_on in (:0, (select released_on as "result" from project_release where id = :1)) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2024-01-15T00:00:00.000Z,
            3,
    ...
    test('customLocalTime-in-n-mixed-const-and-value-source', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where cutoff_time in (:0, (select cutoff_time as "result" from project_release where id = :1)) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1970-01-01T17:00:00.000Z,
            3,
    ...
    test('customLocalDateTime-in-n-mixed-const-and-value-source', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tProjectRelease)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from project_release where signed_off_at in (:0, (select signed_off_at as "result" from project_release where id = :1)) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2024-01-14T12:30:00.000Z,
            3,
    ...
    test('boolean-in-n-mixed-const-and-value-source', async () => {
        ...
        const rows = await ctx.conn.selectFrom(tIssueWorklog)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id" from issue_worklog where billable in (:0, (select billable as "result" from issue_worklog where id = :1)) order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
            2,
