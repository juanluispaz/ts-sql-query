...
describe(ctx.label, () => {
    ...
    test('docs:insert/insert-one-set', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            // doc-start
            const id = sync(connection.insertInto(tOrganization)
                .set({
                    name: 'Initrode',
                    plan: 'free',
                })
    ...
    test('docs:insert/insert-set-if-not-set', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            // doc-start
            const id = sync(connection.insertInto(tIssue)
                .set({
                    projectId: 1,
                    number:    99,
    ...
    test('docs:insert/insert-returning', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            // doc-start
            const inserted = sync(connection.insertInto(tOrganization)
                .set({
    ...
    test('docs:insert/insert-on-conflict-do-nothing', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            // doc-start
            const maybeInserted = sync(connection.insertInto(tOrganization)
                .set({
                    name: 'Acme Corp',
                    plan: 'pro',
                })
    ...
    test('docs:insert/insert-on-conflict-do-update', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            // doc-start
            const upserted = sync(connection.insertInto(tOrganization)
                .set({
                    name: 'Acme Corp',
                    plan: 'pro',
                })
    ...
    test('docs-extra:insert/insert-returning-one-column', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            const name = sync(connection.insertInto(tOrganization)
                .set({ name: 'Initech', plan: 'free' })
