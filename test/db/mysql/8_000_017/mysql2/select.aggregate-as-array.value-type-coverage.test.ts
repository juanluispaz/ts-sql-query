...
describe(ctx.label, () => {
    ...
    test('aggregate-of-boolean-column-as-array', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select issue.id as id, cast(json_arrayagg((project.published = 't')) as char) as published from issue left join project on project.id = issue.project_id where issue.id = ? group by issue.id"`)
    ...
    test('aggregate-of-local-date-time-column-as-array', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select project_id as projectId, cast(json_arrayagg(created_at) as char) as createdAts from issue where project_id = ? group by project_id"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('aggregate-of-local-date-column-as-array', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select issue_id as issueId, cast(json_arrayagg(work_date) as char) as dates from issue_worklog where issue_id = ? group by issue_id"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('aggregate-of-optional-local-date-time-column-as-array', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select issue.id as id, cast(json_arrayagg(project.archived_at) as char) as archivedAts from issue left join project on project.id = issue.project_id where issue.id = ? group by issue.id"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('aggregate-of-bigint-column-as-array', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            expect(ctx.lastSql).toMatchInlineSnapshot(`"select project_id as projectId, cast(json_arrayagg(view_count) as char) as views from issue where project_id = ? group by project_id"`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                1,
              ]
    ...
    test('aggregate-of-optional-double-column-as-array', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            expect(ctx.lastSql).toMatchInlineSnapshot(`"select project_id as projectId, cast(json_arrayagg(estimated_hours) as char) as hours from issue where project_id = ? group by project_id"`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                1,
              ]
    ...
    test('aggregate-of-optional-uuid-column-as-array', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            expect(ctx.lastSql).toMatchInlineSnapshot(`"select project_id as projectId, cast(json_arrayagg(bin_to_uuid(external_ref)) as char) as refs from issue where project_id = ? group by project_id"`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                1,
              ]
    ...
    test('aggregate-of-object-with-bigint-uuid-and-double', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            expect(ctx.lastSql).toMatchInlineSnapshot(`"select project_id as projectId, cast(json_arrayagg(json_object('views', view_count, 'externalRef', bin_to_uuid(external_ref), 'estimatedHours', estimated_hours)) as char) as issues from issue where project_id = ? group by project_id"`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                1,
              ]
    ...
    test('aggregate-of-object-with-boolean-and-local-date-time', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select issue.id as id, cast(json_arrayagg(json_object('published', (project.published = 't'), 'createdAt', project.created_at)) as char) as projects from issue left join project on project.id = issue.project_id where issue.id = ? group by issue.id"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('aggregate-of-object-with-adapter-transformed-columns', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select project_id as projectId, cast(json_arrayagg(json_object('score', score, 'reviewer', reviewer_code)) as char) as reviews from project_review where project_id = ? group by project_id"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('aggregate-of-one-column-optional-branded-adapter-strips-null', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select project_id as projectId, cast(json_arrayagg(optional_release_ordinal) as char) as ords from release_overview where project_id = ? group by project_id"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('aggregate-of-double-column-as-wrapped-array', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, cast((select json_arrayagg(a_1_.result) from (select estimated_hours as result from issue where project_id = project.id order by result limit 2147483647) as a_1_) as char) as hours from project where id = ?"`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                1,
              ]
    ...
    test('aggregate-of-bigint-column-as-wrapped-array', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, cast((select json_arrayagg(a_1_.result) from (select view_count as result from issue where project_id = project.id order by result limit 2147483647) as a_1_) as char) as views from project where id = ?"`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                1,
              ]
    ...
    test('aggregate-of-uuid-column-as-wrapped-array', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, cast((select json_arrayagg(bin_to_uuid(a_1_.result)) from (select external_ref as result from issue where project_id = project.id order by result limit 2147483647) as a_1_) as char) as refs from project where id = ?"`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                1,
              ]
    ...
    test('aggregate-of-local-date-time-column-as-wrapped-array', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, cast((select json_arrayagg(a_1_.result) from (select created_at as result from issue where project_id = project.id order by result limit 2147483647) as a_1_) as char) as stamps from project where id = ?"`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                1,
              ]
    ...
    test('aggregate-of-boolean-column-as-wrapped-array', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, cast((select json_arrayagg(a_1_.result) from (select billable as result from issue_worklog where issue_id = issue.id order by result limit 2147483647) as a_1_) as char) as flags from issue where id = ?"`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                1,
              ]
    ...
    test('aggregate-of-local-date-column-as-wrapped-array', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, cast((select json_arrayagg(a_1_.result) from (select work_date as result from issue_worklog where issue_id = issue.id order by result limit 2147483647) as a_1_) as char) as dates from issue where id = ?"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('aggregate-of-custom-double-column-as-wrapped-array', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, cast((select json_arrayagg(a_1_.result) from (select billed_amount as result from issue_worklog where issue_id = issue.id order by result limit 2147483647) as a_1_) as char) as amounts from issue where id = ?"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('aggregate-of-local-time-column-as-wrapped-array', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, cast((select json_arrayagg(a_1_.result) from (select started_at as result from issue_worklog where issue_id = issue.id order by result limit 2147483647) as a_1_) as char) as clocks from issue where id = ?"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('aggregate-of-custom-uuid-column-as-wrapped-array', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, cast((select json_arrayagg(bin_to_uuid(a_1_.result)) from (select signing_key as result from project_release where project_id = project.id order by result limit 2147483647) as a_1_) as char) as \`keys\` from project where id = ?"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('aggregate-of-custom-local-date-column-as-wrapped-array', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, cast((select json_arrayagg(a_1_.result) from (select released_on as result from project_release where project_id = project.id order by result limit 2147483647) as a_1_) as char) as days from project where id = ?"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('aggregate-of-custom-local-time-column-as-wrapped-array', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, cast((select json_arrayagg(a_1_.result) from (select cutoff_time as result from project_release where project_id = project.id order by result limit 2147483647) as a_1_) as char) as cutoffs from project where id = ?"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('aggregate-of-custom-local-date-time-column-as-wrapped-array', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, cast((select json_arrayagg(a_1_.result) from (select signed_off_at as result from project_release where project_id = project.id order by result limit 2147483647) as a_1_) as char) as signoffs from project where id = ?"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('aggregate-of-wrapped-object-with-uuid-column', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as id, cast((select json_arrayagg(json_object('ref', bin_to_uuid(a_1_.ref), 'cnt', a_1_.cnt)) from (select external_ref as ref, count(id) as cnt from issue where project_id = project.id group by external_ref) as a_1_) as char) as refs from project where id = ?"`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                1,
              ]
