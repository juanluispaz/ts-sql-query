...
import type { ShapeFor, UpdateSets, UpdateValues } from "../expressions/update"
...
export type UpdatableRow<TABLE> = TABLE extends ITable<any>
    ...
    : MakeTypeVisible<UpdateSets<ITable<any>, TABLE & ITable<any>, ShapeFor<ITable<any>>>>
export type UpdatableValues<TABLE> = TABLE extends ITable<any>
    ? MakeTypeVisible<UpdateValues<TABLE, undefined>>
    : MakeTypeVisible<UpdateValues<ITable<any>, ShapeFor<ITable<any>>>>
