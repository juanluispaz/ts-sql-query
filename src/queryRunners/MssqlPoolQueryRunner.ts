...
import type { ConnectionPool, ISqlTypeFactory, Request, Transaction } from 'mssql'
...
import { getMssqlErrorReason, isMssqlError } from './connectorErrorMappers/MssqlErrorMapper.js'

const { TYPES, ISOLATION_LEVEL } = mssql
