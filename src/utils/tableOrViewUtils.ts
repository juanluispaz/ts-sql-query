...
import type { Column, ComputedColumn, PrimaryKeyAutogeneratedColumn } from "./Column"
...
export type OldValues<TABLE_OR_VIEW extends ITableOrView<any>> = { [K in ColumnsOfTableOrView<TABLE_OR_VIEW>]: RemapValueSourceType<OLD<TABLE_OR_VIEW[typeof tableOrViewRef]>, TABLE_OR_VIEW[K]> } & OldTableOrView<TABLE_OR_VIEW>
...
export type AutogeneratedPrimaryKeyColumnsTypesOf<T extends ITableOrView<any>> = ({ [K in keyof T]-?: 
    T[K] extends IValueSource<T[typeof tableOrViewRef], infer TYPE> & Column 
    ? (
