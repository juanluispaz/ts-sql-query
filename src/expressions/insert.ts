...
import type { AutogeneratedPrimaryKeyColumnsTypesOf, ColumnsForSetOf, ColumnsForSetOfWithShape, ColumnsKeyOf, OptionalColumnsForSetOf, OptionalColumnsForSetOfWithShape, RequiredColumnsForSetOf, RequiredColumnsForSetOfWithShape, ResolveShape } from '../utils/tableOrViewUtils.js'
import type { MandatoryPropertiesOf } from '../utils/resultUtils.js'
import type { NNoTableOrViewRequiredFrom, NSource, NValuesForInsertFrom } from '../utils/sourceName.js'
...
export interface ShapedInsertExpression</*in|out*/ TABLE extends HasSource<any>, /*in|out*/ USING extends HasSource<any>, /*in|out*/ SHAPE, /*in|out*/ MISSING_KEYS_IN_SHAPE> extends InsertExpressionBase<TABLE, USING> {
    ...
    setIfValue<COLUMNS extends MandatoryOptionalInsertSets<TABLE, USING, SHAPE>>(columns: COLUMNS): MaybeShapedExecutableInsertExpression<TABLE, USING, SHAPE, Exclude<RequiredColumnsForSetOfWithShape<TABLE, SHAPE>, NonOptionalKeys<COLUMNS>>, MISSING_KEYS_IN_SHAPE>
...
type OnConflictReturningLastInsertedIdType<TABLE extends HasSource<any>, USING extends HasSource<any>> =
    TABLE extends OfDB<'noopDB' | 'postgreSql' | 'sqlServer' | 'oracle' | 'sqlite' | 'mariaDB'>
    ? [AutogeneratedPrimaryKeyColumnsTypesOf<TABLE>] extends [never] ? never : () =>  CustomizableExecutableInsertReturningLastInsertedId<TABLE, USING, AutogeneratedPrimaryKeyColumnsTypesOf<TABLE>>
    : never
