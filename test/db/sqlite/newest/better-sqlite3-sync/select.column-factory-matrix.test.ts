...
describe(ctx.label, () => {
    ...
    test('required-column-factory-projects-each-kind', async () => {
        ...
        const row = sync(ctx.conn.selectFrom(tColMatrixColumn)
            .select({
    ...
    test('optional-column-factory-projects-each-kind', async () => {
        ...
        ctx.mockNext(matrixRow)
        const row = sync(ctx.conn.selectFrom(tColMatrixOptional)
            .select({
    ...
    test('column-with-default-value-factory-projects-each-kind', async () => {
        ...
        ctx.mockNext(matrixRow)
        const row = sync(ctx.conn.selectFrom(tColMatrixDefault)
            .select({
    ...
    test('optional-column-with-default-value-factory-projects-each-kind', async () => {
        ...
        ctx.mockNext(matrixRow)
        const row = sync(ctx.conn.selectFrom(tColMatrixOptionalDefault)
            .select({
    ...
    test('computed-column-factory-projects-each-kind', async () => {
        ...
        ctx.mockNext(matrixRow)
        const row = sync(ctx.conn.selectFrom(tColMatrixComputed)
            .select({
    ...
    test('optional-computed-column-factory-projects-each-kind', async () => {
        ...
        ctx.mockNext(matrixRow)
        const row = sync(ctx.conn.selectFrom(tColMatrixOptionalComputed)
            .select({
    ...
    test('primary-key-factory-projects-each-comparable-kind', async () => {
        ...
        const row = sync(ctx.conn.selectFrom(tColMatrixPk)
            .select({
                id:       tColMatrixPk.id,
    ...
    test('view-required-column-factory-projects-each-kind', async () => {
        ...
        ctx.mockNext(matrixRow)
        const row = sync(ctx.conn.selectFrom(vColMatrix)
            .select({
                id:          vColMatrix.id,
    ...
    test('required-column-factory-adapter-transforms-each-kind', async () => {
        ...
        ctx.mockNext(matrixRow)
        const row = sync(ctx.conn.selectFrom(tColMatrixColumnAdapter)
            .select({
    ...
    test('optional-column-factory-adapter-transforms-each-kind', async () => {
        ...
        // `?: T`).
        ctx.mockNext(matrixRow)
        const row = sync(ctx.conn.selectFrom(tColMatrixOptionalAdapter)
            .select({
    ...
    test('column-with-default-value-factory-adapter-transforms-each-kind', async () => {
        ...
        ctx.mockNext(matrixRow)
        const row = sync(ctx.conn.selectFrom(tColMatrixDefaultAdapter)
            .select({
    ...
    test('optional-column-with-default-value-factory-adapter-transforms-each-kind', async () => {
        ...
        ctx.mockNext(matrixRow)
        const row = sync(ctx.conn.selectFrom(tColMatrixOptionalDefaultAdapter)
            .select({
    ...
    test('computed-column-factory-adapter-transforms-each-kind', async () => {
        ...
        ctx.mockNext(matrixRow)
        const row = sync(ctx.conn.selectFrom(tColMatrixComputedAdapter)
            .select({
    ...
    test('optional-computed-column-factory-adapter-transforms-each-kind', async () => {
        ...
        ctx.mockNext(matrixRow)
        const row = sync(ctx.conn.selectFrom(tColMatrixOptionalComputedAdapter)
            .select({
    ...
    test('view-required-column-factory-adapter-transforms-each-kind', async () => {
        ...
        ctx.mockNext(matrixRow)
        const row = sync(ctx.conn.selectFrom(vColMatrixAdapter)
            .select({
    ...
    test('table-virtual-column-factory-adapter-transforms-each-kind', async () => {
        ...
        ctx.mockNext(matrixRow)
        const row = sync(ctx.conn.selectFrom(tColMatrixVirtualAdapter)
            .select({
    ...
    test('view-virtual-column-factory-adapter-transforms-each-kind', async () => {
        ...
        ctx.mockNext(matrixRow)
        const row = sync(ctx.conn.selectFrom(vColMatrixVirtualAdapter)
            .select({
