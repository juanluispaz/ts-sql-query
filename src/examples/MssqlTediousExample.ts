/*
 * npm install mssql
 * docker run --name ts-sql-query-sqlserver -e 'ACCEPT_EULA=Y' -e 'MSSQL_SA_PASSWORD=yourStrong(!)Password' -p 1433:1433 -d mcr.microsoft.com/azure-sql-edge:1.0.7
 */
...
async function main() {
    const connection = new DBConnection(new ConsoleLogQueryRunner(new MssqlPoolPromiseQueryRunner(poolPromise)))
