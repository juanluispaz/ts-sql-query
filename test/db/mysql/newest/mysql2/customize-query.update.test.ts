...
describe(ctx.label, () => {
    ...
    test('customize-update-hook-fragment-with-bound-param', async () => {
        ...
        // tests-audit-disable-next-line mock-only -- bound param lands inside a /* */ comment; drivers strip the comment on the mutation path then reject the extra ? ("expected 2 values, received 3") (DESIGN §1 #18)
