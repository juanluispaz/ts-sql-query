...
describe(ctx.label, () => {
    ...
    // emits uuid_blob/uuid_str, which this connector does not register (its
    // example uses the 'string' uuid strategy instead). BigInt binds fine, so
    // the bigint test stays live here. See test/FUTURE_CONNECTORS.md.
    /*
