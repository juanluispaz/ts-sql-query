...
// trig family.
//
// MySQL exposes the standard SQL trig functions
// `acos`/`asin`/`atan`/`cos`/`cot`/`sin`/`tan` natively, so every cell
// runs end-to-end against the real DB and the runtime value is asserted
// with `toBeCloseTo`.
//
