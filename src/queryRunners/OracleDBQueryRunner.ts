...
function getOracleDbErrorReason(error: DBError): TsSqlErrorReason {
    ...
    const databaseErrorNumber = typeof errorNum === 'number' ? errorNum : undefined
    const databaseErrorMessage = error.message || undefined

    switch (errorNum) {
        case 1:
            return { reason: 'SQL_CONSTRAINT_VIOLATED', databaseErrorCode, databaseErrorNumber, databaseErrorMessage, constraintType: 'unique', constraintName: extractOracleConstraintName(error.message) }
        case 1400:
            return { reason: 'SQL_CONSTRAINT_VIOLATED', databaseErrorCode, databaseErrorNumber, databaseErrorMessage, constraintType: 'not null', tableName: extractOracleTableName(error.message), columnName: extractOracleColumnName(error.message) }
        case 2291:
        case 2292:
            return { reason: 'SQL_CONSTRAINT_VIOLATED', databaseErrorCode, databaseErrorNumber, databaseErrorMessage, constraintType: 'foreign key', constraintName: extractOracleConstraintName(error.message) }
        case 2290:
            return { reason: 'SQL_CONSTRAINT_VIOLATED', databaseErrorCode, databaseErrorNumber, databaseErrorMessage, constraintType: 'check', constraintName: extractOracleConstraintName(error.message) }
        case 12899:
            return { reason: 'SQL_INVALID_VALUE', databaseErrorCode, databaseErrorNumber, databaseErrorMessage, errorType: 'too long', columnName: extractOracleColumnName(error.message) }
        case 1438:
        case 1455:
        ...
        case 942:
            return { reason: 'SQL_OBJECT_NOT_FOUND', databaseErrorCode, databaseErrorNumber, databaseErrorMessage, objectType: 'table or view', objectName: extractOracleObjectName(error.message) }
        case 904:
            return { reason: 'SQL_OBJECT_NOT_FOUND', databaseErrorCode, databaseErrorNumber, databaseErrorMessage, objectType: 'column', columnName: extractOracleColumnName(error.message), objectName: extractOracleObjectName(error.message) }
        case 1006:
        case 1008:
        case 1036:
            return { reason: 'SQL_INVALID_PARAMETER', databaseErrorCode, databaseErrorNumber, databaseErrorMessage }
        case 4043:
            return { reason: 'SQL_OBJECT_NOT_FOUND', databaseErrorCode, databaseErrorNumber, databaseErrorMessage, objectName: extractOracleObjectName(error.message) }
        case 6550:
            return { reason: 'SQL_SYNTAX_ERROR', databaseErrorCode, databaseErrorNumber, databaseErrorMessage }
        case 955:
            return { reason: 'SQL_OBJECT_ALREADY_EXISTS', databaseErrorCode, databaseErrorNumber, databaseErrorMessage, objectName: extractOracleObjectName(error.message) }
        case 933:
        case 907:
        case 936:
        case 923:
        case 1756:
            return { reason: 'SQL_SYNTAX_ERROR', databaseErrorCode, databaseErrorNumber, databaseErrorMessage }
        case 918:
            return { reason: 'SQL_AMBIGUOUS_IDENTIFIER', databaseErrorCode, databaseErrorNumber, databaseErrorMessage, identifier: extractQuotedName(error.message) }
        case 1427:
