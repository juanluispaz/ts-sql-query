// Shared connection definition for the pilot-postgres dialect: used by the
// real postgres backend (testcontainers) AND by pglite. The only thing
// that changes between them is the QueryRunner injected into the
// constructor and, for postgres, the `compatibilityVersion` we want the
// test variant to target.
