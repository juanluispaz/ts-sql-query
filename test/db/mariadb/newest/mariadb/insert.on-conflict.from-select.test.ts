...
describe(ctx.label, () => {
    ...
    */
    ...
    // NOT-APPLICABLE: MariaDB has no targeted INSERT…ON CONFLICT (onConflictOnConstraint is not typed; the ON DUPLICATE KEY UPDATE grammar takes no conflict target)
    /*
