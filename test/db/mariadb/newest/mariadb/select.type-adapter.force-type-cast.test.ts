...
// PostgreSQL-specific by intent, so on MariaDB the tests are kept
...
describe(ctx.label, () => {
    ...
    // NOT-APPLICABLE: MariaDB — ForceTypeCast emits a PostgreSQL `::<type>` placeholder cast; other dialects no-op
    /*
