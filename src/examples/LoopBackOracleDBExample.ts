...
async function main() {
    ...
    try {
        ...
        try {
            await connection.queryRunner.executeDatabaseSchemaModification(`drop table boolean_table`)
        } catch { /* do nothing*/ }
        await connection.queryRunner.executeDatabaseSchemaModification(`
            create table boolean_table (
                id integer generated always as identity primary key,
                bool_a number(1) not null check (bool_a = 0 or bool_a = 1),
                opt_bool_b number(1) null check (opt_bool_b = 0 or opt_bool_b = 1),
