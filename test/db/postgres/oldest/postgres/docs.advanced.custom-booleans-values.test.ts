...
describe(ctx.label, () => {
    ...
    test('docs:custom-booleans-values/insert-maps-true-false-to-Y-N', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"insert into flag_table_only_for_sql_test (name, active) values ($1, case when $2::bool then 'Y' else 'N' end) returning id"`)
