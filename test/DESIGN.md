...
[`TEST_LIB.md` § `auditTestSymmetry.ts`](./TEST_LIB.md#audittestsymmetryts--the-symmetry-audit).
...
(`NON_CELL_CONNECTORS` / `NON_CELL_DATABASES` in `auditTestSymmetry.ts`). They are
