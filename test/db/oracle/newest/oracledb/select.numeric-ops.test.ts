...
describe(ctx.label, () => {
    ...
    test('floor', async () => {
        ...
        const result = await ctx.conn.selectFrom(tIssue)
            ...
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", floor(priority / :0) as "f" from issue where id = :1"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2,
            1,
    ...
    test('ceil', async () => {
        ...
        const result = await ctx.conn.selectFrom(tIssue)
            ...
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", ceil(priority / :0) as "c" from issue where id = :1"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            3,
            1,
    ...
    test('round', async () => {
        ...
        const result = await ctx.conn.selectFrom(tIssue)
            ...
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", round(priority / :0) as "r" from issue where id = :1"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2,
            2,
    ...
    test('cbrt', async () => {
        ...
        const result = await ctx.conn.selectFrom(tIssue)
            ...
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", sign(priority * :0) * power(abs(priority * :1), 1.0e0 / 3.0e0) as "c" from issue where id = :2"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            4,
            4,
    ...
    test('power-fractional-exponent-keeps-the-fraction', async () => {
        ...
        const result = await ctx.conn.selectFrom(tIssue)
            ...
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", power(priority, :0) as "r" from issue where id = :1"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            0.5,
            1,
    ...
    test('exp-and-ln', async () => {
        ...
        const result = await ctx.conn.selectFrom(tIssue)
            ...
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", ln(exp(priority)) as "lnExp" from issue where id = :0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('log10', async () => {
        ...
        const result = await ctx.conn.selectFrom(tIssue)
            ...
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", log(10, power(priority, :0) * :1) as "l" from issue where id = :2"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2,
            25,
    ...
    test('logn', async () => {
        ...
        const result = await ctx.conn.selectFrom(tIssue)
            ...
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", log(:0, power(priority, :1)) as "l" from issue where id = :2"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2,
            3,
    ...
    test('roundn-decimals', async () => {
        ...
        const result = await ctx.conn.selectFrom(tIssue)
            ...
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", round(priority / :0, :1) as "r" from issue where id = :2"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            3,
            2,
    ...
    test('atan2', async () => {
        ...
        const result = await ctx.conn.selectFrom(tIssue)
            ...
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", atan2(priority, :0) as "a" from issue where id = :1"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2,
            1,
    ...
    test('asDouble', async () => {
        ...
        const result = await ctx.conn.selectFrom(tIssue)
            ...
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", cast(priority as float) as "d" from issue where id = :0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('nullIfValue', async () => {
        ...
        const result = await ctx.conn.selectFrom(tIssue)
            ...
            .orderBy('id')
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", nullif(priority, :0) as "p" from issue order by "id""`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            3,
          ]
    ...
    test('ceil-int-receiver', async () => {
        ...
        const result = await ctx.conn.selectFrom(tIssue)
            ...
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", ceil(priority) as "c" from issue where id = :0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('floor-int-receiver', async () => {
        ...
        const result = await ctx.conn.selectFrom(tIssue)
            ...
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", floor(priority) as "f" from issue where id = :0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('round-int-receiver', async () => {
        ...
        const result = await ctx.conn.selectFrom(tIssue)
            ...
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", round(priority) as "r" from issue where id = :0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('logn-int-receiver', async () => {
        ...
        const result = await ctx.conn.selectFrom(tIssue)
            ...
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", log(:0, priority) as "l" from issue where id = :1"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2,
            1,
    ...
    test('optional-double-receiver-unary-f1-fan-out', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", abs(estimated_hours) as "ab", ceil(estimated_hours) as "ce", floor(estimated_hours) as "fl", sign(estimated_hours) as "sg", sign(estimated_hours) * power(abs(estimated_hours), 1.0e0 / 3.0e0) as "cb", exp(estimated_hours) as "ex", ln(estimated_hours) as "ln", log(10, estimated_hours) as "l10", log(:0, estimated_hours) as "lgn", round(estimated_hours, :1) as "rn", atan2(estimated_hours, :2) as "at", cast(round(estimated_hours) as number(38)) as "ai", cast(round(estimated_hours) as number(38)) as "abi", cast(estimated_hours as float) as "ad" from issue where id = :3"`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                2,
                2,
    ...
    test('double-required-receiver-unary-f1-fan-out', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", abs(cast(priority as float)) as "ab", ceil(cast(priority as float)) as "ce", floor(cast(priority as float)) as "fl", sign(cast(priority as float)) as "sg", sign(cast(priority as float)) * power(abs(cast(priority as float)), 1.0e0 / 3.0e0) as "cb", exp(cast(priority as float)) as "ex", ln(cast(priority as float)) as "ln", log(10, cast(priority as float)) as "l10", power(cast(priority as float), :0) as "pw", log(:1, cast(priority as float)) as "lgn", round(cast(priority as float), :2) as "rn", atan2(cast(priority as float), :3) as "at", greatest(cast(priority as float), :4) as "mn", least(cast(priority as float), :5) as "mx" from issue where id = :6"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2,
            2,
    ...
    test('optional-bigint-receiver-rounding-arithmetic-fan-out', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", ceil(duration_ms) as "ce", floor(duration_ms) as "fl", round(duration_ms) as "ro", duration_ms - :0 as "s", mod(duration_ms, :1) as "mo", greatest(duration_ms, :2) as "mn", least(duration_ms, :3) as "mx" from issue_worklog where id = :4"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            400000n,
            1000000n,
    ...
    test('optional-int-receiver-unary-f1-fan-out', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", abs(assignee_id) as "ab", ceil(assignee_id) as "ce", floor(assignee_id) as "fl", sign(assignee_id) as "sg", sqrt(assignee_id) as "sq", sign(assignee_id) * power(abs(assignee_id), 1.0e0 / 3.0e0) as "cb", exp(assignee_id) as "ex", ln(assignee_id) as "ln", log(10, assignee_id) as "l10", power(assignee_id, :0) as "pw", log(:1, assignee_id) as "lgn", round(assignee_id, :2) as "rn", atan2(assignee_id, :3) as "at", cast(assignee_id as float) as "ad", assignee_id as "abi" from issue where id = :4"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2,
            3,
    ...
    test('asInt-chained-into-numeric-op', async () => {
        ...
        const result = await ctx.conn.selectFrom(tIssue)
            ...
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", mod(cast(round(cast(priority as float)) as number(38)), :0) as "m", cast(round(cast(priority as float)) as number(38)) + :1 as "a" from issue where id = :2"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2,
            1,
    ...
    test('asBigint-chained-into-bigint-op', async () => {
        ...
        const result = await ctx.conn.selectFrom(tIssue)
            ...
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", priority + :0 as "a", mod(priority, :1) as "m" from issue where id = :2"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            2n,
            2n,
