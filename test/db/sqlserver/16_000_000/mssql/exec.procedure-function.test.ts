...
describe(ctx.label, () => {
    ...
    test('execute-function-returning-bigint', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select dbo.total_view_count(@0)"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('execute-function-returning-optional-local-date-time', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select dbo.latest_issue_at(@0)"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('execute-function-returning-custom-double', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select dbo.estimated_total(@0)"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('execute-function-returning-boolean', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select dbo.ret_flag(@0)"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('execute-function-returning-uuid', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select dbo.ret_uuid(@0)"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('execute-function-returning-local-date', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select dbo.ret_day(@0)"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('execute-function-returning-local-time', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select dbo.ret_clock(@0)"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('execute-function-returning-enum', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select dbo.ret_activity(@0)"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('execute-function-returning-custom', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select dbo.ret_channel(@0)"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('execute-function-returning-custom-comparable', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select dbo.ret_semver(@0)"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
