...
describe(ctx.label, () => {
    ...
    test('docs:basic/select-one', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", name as "name", slug as "slug" from project where id = :0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('docs:basic/projecting-optional-values-as-nullable', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "id", name as "name", archived_at as "archivedAt" from project where id = :0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('docs-extra:basic/select-one-column', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select name as "result" from project where id = :0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
