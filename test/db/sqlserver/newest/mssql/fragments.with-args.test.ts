...
describe(ctx.label, () => {
    ...
    test('build-fragment-with-args-coerces-int-literals', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select @0 << @1 as [r]"`)
    ...
    test('build-fragment-with-args-if-value-emits-when-value-present', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select @0 as [x] where @1 = @2"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
            1,
    ...
    test('build-fragment-with-args-if-value-short-circuits-noop-on-undefined', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select @0 as [x]"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('build-fragment-with-args-arity-1-over-bigint-arg', async () => {
        ...
        const rows = await ctx.conn.selectFromNoTable()
            ...
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select abs(@0) as [r]"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            -5n,
          ]
    ...
    test('build-fragment-with-args-if-value-arity-1-emits-when-present', async () => {
        ...
        await ctx.conn.selectFromNoTable()
            ...
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select @0 as [x] where @1 > 0"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
            5,
    ...
    test('build-fragment-with-maybe-optional-args-arity-3-over-string', async () => {
        ...
        const rows = await ctx.conn.selectFromNoTable()
            ...
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select coalesce(@0, @1, @2) as [r]"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "a",
            null,
    ...
    test('args-arity-5-coalesce', async () => {
        ...
        const rows = await ctx.conn.selectFromNoTable()
            ...
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select coalesce(@0, @1, @2, @3, @4) as [r]"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "a",
            "b",
    ...
    test('maybe-optional-args-arity-4-coalesce', async () => {
        ...
        const rows = await ctx.conn.selectFromNoTable()
            ...
            .executeSelectMany()
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select coalesce(@0, @1, @2, @3) as [r]"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            "a",
            null,
