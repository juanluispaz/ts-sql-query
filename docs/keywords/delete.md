...
| LIMIT             | Not supported yet. Use custom SQL Fragment. | Restricts the number of rows that are deleted.             | [Customizing a delete](../queries/sql-fragments.md#customizing-a-delete) |
...
| TOP               | Not supported yet. Use custom SQL Fragment. | Restricts the number of rows that are deleted.             | [Customizing a delete](../queries/sql-fragments.md#customizing-a-delete)           |
