...
export function getOracleDBErrorReason(error: unknown): TsSqlErrorReason {
...
export function isOracleDBError(error: unknown): error is DBError {
    return isOracleDbError(error)
}
