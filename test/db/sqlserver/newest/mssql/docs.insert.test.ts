...
describe(ctx.label, () => {
    ...
    test('docs:insert/insert-many-values', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            expect(ctx.lastSql).toMatchInlineSnapshot(`"insert into project (name, organization_id, slug) output inserted.id as id values (@0, @1, @2), (@3, @4, @5)"`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                "Mobile app",
                1,
    ...
    test('docs:insert/insert-set-if-not-set', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            expect(ctx.lastSql).toMatchInlineSnapshot(`"insert into issue (project_id, number, title, status, priority, body) output inserted.id values (@0, @1, @2, @3, @4, @5)"`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                1,
                99,
    ...
    test('docs:insert/insert-with-shape', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            expect(ctx.lastSql).toMatchInlineSnapshot(`"insert into project (name, slug, organization_id) output inserted.id values (@0, @1, @2)"`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                "Operations",
                "ops",
    ...
    // Not applicable on SQL Server: SQL Server does not support insert on conflict.
    /*
    ...
    */
    ...
    // Not applicable on SQL Server: SQL Server does not support insert ... on conflict do update.
    /*
    ...
    */
    ...
    test('docs-extra:insert/insert-returning-one-column', async () => {
        ...
        await ctx.withRollback(async () => {
            ...
            expect(ctx.lastSql).toMatchInlineSnapshot(`"insert into organization (name, [plan]) output inserted.name as [result] values (@0, @1)"`)
            expect(ctx.lastParams).toMatchInlineSnapshot(`
              [
                "Initech",
                "free",
