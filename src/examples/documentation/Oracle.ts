...
import type { DynamicPickPaths, PickValuesPath } from '../../dynamic/pick.js'
import type { DynamicCondition } from '../../dynamic/condition.js'
import { dynamicPick, dynamicPickPaths, expandTypeFromDynamicPickPaths } from '../../dynamic/pick.js'
...
async function main() {
    ...
    expectedQuery.push(`select id as "id", first_name as "name.firstName", last_name as "name.lastName", birthday as "birthday" from customer where company_id = :0 order by "name.firstName", "name.lastName"`)
    ...
    result = []
    expectedResult.push(result)
    expectedQuery.push(`select id as "id", first_name || :0 || last_name as "name", birthday as "birthday" from customer where first_name like ('%' || :1 || '%') escape '\\' order by lower("name"), "birthday" asc nulls last`)
    ...
    result = []
    expectedResult.push(result)
    expectedQuery.push(`select id as "customerId", first_name as "customerFirstName", last_name as "customerLastName" from customer where company_id in (select id as "result" from company where name like ('%' || :0 || '%') escape '\\') order by "customerFirstName" asc nulls first, "customerLastName"`)
    ...
    expectedResult.push([])
    expectedQuery.push(`select id as "id", first_name as "firstName", last_name as "lastName" from customer where lower(first_name) like lower(:0 || '%') escape '\\' or lower(last_name) like lower(:1 || '%') escape '\\' order by "firstName", "lastName" offset :2 rows fetch next :3 rows only`)
    expectedParams.push(`["Smi","Smi",20,10]`)
    expectedType.push(`selectManyRows`)
    expectedResult.push(0)
    expectedQuery.push(`select count(*) from customer where lower(first_name) like lower(:0 || '%') escape '\\' or lower(last_name) like lower(:1 || '%') escape '\\'`)
    ...
    result = null
    expectedResult.push(result)
    expectedQuery.push(`select id::varchar as "idAsString", first_name || :0 || last_name as "name" from customer where !!id = !!:1`)
    expectedParams.push(`[" ",10]`)
    expectedType.push(`selectOneRow`)
    ...
    result = []
    expectedResult.push(result)
    expectedQuery.push(`select id as "id", name as "name" from company where id + 1 = :0`)
    ...
    result = 1
    expectedResult.push(result)
    expectedQuery.push(`insert into customer (first_name, last_name, company_id, birthday) values (:0, :1, :2, :3) returning id into :4`)
    expectedParams.push(`["John","Smith",1,"2000-03-01T00:00:00.000Z",{"dir":3003}]`)
    ...
    result = 1
    expectedResult.push(result)
    expectedQuery.push(`insert into customer (first_name, last_name, company_id) values (:0, :1, :2) returning id into :3`)
    expectedParams.push(`["John","Smith",23,{"dir":3003}]`)
    expectedType.push(`insertReturningLastInsertedId`)
    ...
    expectedParams.push(`["John","Smith",1,{"dir":3003},"Other","Person",1,{"dir":3003}]`)
    ...
    result = 1
    expectedResult.push(result)
    expectedQuery.push(`insert into customer (first_name, last_name, company_id, birthday) values (:0, :1, :2, :3)`)
    ...
    result = 1
    expectedResult.push(result)
    expectedQuery.push(`insert into customer (first_name, last_name, company_id) select first_name as "firstName", last_name as "lastName", company_id as "companyId" from customer where company_id = :0`)
    ...
    result = 1
    expectedResult.push(result)
    expectedQuery.push(`update customer set first_name = :0, last_name = :1 where id = :2`)
    ...
    result = 1
    expectedResult.push(result)
    expectedQuery.push(`update customer set first_name = :0, last_name = :1, company_id = :2 where id = :3`)
    ...
    result = 1
    expectedResult.push(result)
    expectedQuery.push(`delete from customer where id = :0`)
    expectedParams.push(`[10]`)
    ...
    result = []
    expectedResult.push(result)
    expectedQuery.push(`select id as "id", first_name || :0 || last_name as "name", :1 as "type" from customer union all select id as "id", name as "name", :2 as "type" from company`)
    ...
    expectedQuery.push(`select customer.id as "id", customer.first_name as "firstName", customer.last_name as "lastName", customer.birthday as "birthday", company.id as "company.id", company.name as "company.name" from customer inner join company on company.id = customer.company_id where customer.id = :0`)
    ...
    expectedQuery.push(`select customer.id as "id", customer.first_name as "name.firstName", customer.last_name as "name.lastName", customer.birthday as "birthday", company.id as "company.id", company.name as "company.name" from customer inner join company on company.id = customer.company_id where company.name = :0 and (lower(customer.first_name) like lower('%' || :1 || '%') escape '\\' or lower(customer.last_name) like lower('%' || :2 || '%') escape '\\') order by lower("company.name") asc, "birthday" desc`)
    ...
    result = []
    expectedResult.push(result)
    expectedQuery.push(`select customer.id as "id", customer.first_name as "firstName", customer.last_name as "lastName", company.name as "companyName" from customer inner join company on company.id = customer.company_id where customer.id = :0`)
    expectedParams.push(`[12]`)
    expectedType.push(`selectManyRows`)
    ...
    result = []
    expectedResult.push(result)
    expectedQuery.push(`select customer.id as "id", customer.first_name as "name.firstName", customer.last_name as "name.lastName", company.name as "company.name" from customer inner join company on company.id = customer.company_id where customer.id = :0`)
    expectedParams.push(`[12]`)
    expectedType.push(`selectManyRows`)
    ...
    result = []
    expectedResult.push(result)
    expectedQuery.push(`select id as "id", first_name as "firstName", last_name as "lastName", birthday as "birthday" from customer for system_time between :0 and :1  where id = :2`)
    ...
    expectedResult.push(result)
    expectedQuery.push(`select /*+ some hints */ id as "id", first_name as "firstName", last_name as "lastName", birthday as "birthday" from customer where id = :0 for update`)
    expectedParams.push(`[10]`)
    expectedType.push(`selectOneRow`)
    ...
    expectedResult.push(result)
    expectedQuery.push(`select /*+ some hints */ id as "id", first_name as "firstName", last_name as "lastName", birthday as "birthday" from customer where id = :0 order by my_column, my_id for update`)
    expectedParams.push(`[10]`)
    expectedType.push(`selectOneRow`)
    ...
    expectedResult.push(result)
    expectedQuery.push(`select /*+ some hints */ id as "id", first_name as "firstName", last_name as "lastName", birthday as "birthday" from customer where id = :0 order by my_column for update`)
    expectedParams.push(`[10]`)
    expectedType.push(`selectOneRow`)
    ...
    expectedResult.push(result)
    expectedQuery.push(`select /*+ some hints */ id as "id", first_name as "firstName", last_name as "lastName", birthday as "birthday" from customer where id = :0 order by my_id for update`)
    expectedParams.push(`[10]`)
    expectedType.push(`selectOneRow`)
    ...
    expectedResult.push(result)
    expectedQuery.push(`select /*+ some hints */ id as "id", first_name as "firstName", last_name as "lastName", birthday as "birthday" from customer where id = :0 order by "id" for update`)
    expectedParams.push(`[10]`)
    expectedType.push(`selectOneRow`)
    ...
    expectedResult.push(result)
    expectedQuery.push(`select /*+ some hints */ id as "id", first_name as "firstName", last_name as "lastName", birthday as "birthday" from customer where id = :0 order by my_column, "id", my_id for update`)
    expectedParams.push(`[10]`)
    expectedType.push(`selectOneRow`)
    ...
    expectedResult.push(result)
    expectedQuery.push(`select /*+ some hints */ id as "id", first_name as "firstName", last_name as "lastName", birthday as "birthday" from customer where id = :0 order by my_column, "id" for update`)
    expectedParams.push(`[10]`)
    expectedType.push(`selectOneRow`)
    ...
    expectedResult.push(result)
    expectedQuery.push(`BEFORE select /*+ some hints */ id as "id", first_name as "firstName", last_name as "lastName", birthday as "birthday" from customer where id = :0 order by "id", my_id for update`)
    expectedParams.push(`[10]`)
    expectedType.push(`selectOneRow`)
    ...
    expectedResult.push(result)
    expectedQuery.push(`select id as "id", first_name as "firstName", last_name as "lastName", birthday as "birthday", company_id as "companyId", first_name || :0 || last_name as "name", calculateAge(birthday) as "age" from customer where id = :1`)
    expectedParams.push(`[" ",9]`)
    expectedType.push(`selectOneRow`)
    ...
    expectedResult.push(result)
    expectedQuery.push(`select id as "result.id", first_name as "result.firstName", last_name as "result.lastName", birthday as "result.birthday", company_id as "result.companyId", first_name || :0 || last_name as "result.name", calculateAge(birthday) as "result.age" from customer where id = :1`)
    expectedParams.push(`[" ",9]`)
    expectedType.push(`selectOneRow`)
    ...
    result = []
    expectedResult.push(result)
    expectedQuery.push(`select id as "id", first_name || :0 || last_name as "name" from customer where company_id = (select id as "result" from company where name = :1)`)
    expectedParams.push(`[" ","ACME"]`)
    expectedType.push(`selectManyRows`)
    ...
    // Oracle doesn't support forUseInQueryAs (with clause) queries that have outer tables that depends on
    ...
    result = []
    expectedResult.push(result)
    expectedQuery.push(`with inner3 as (select id as id, name as name from custom_company) select id as "customerId", first_name as "customerFirstName", last_name as "customerLastName" from customer where company_id in (select inner3.id as "result" from company inner join inner3 on company.id = inner3.id where company.name like ('%' || :0 || '%') escape '\\')`)
    expectedParams.push(`["Cia."]`)
    expectedType.push(`selectManyRows`)
    ...
    result = 1
    expectedResult.push(result)
    expectedQuery.push(`insert into record (id, title) values (uuid_to_raw(:0), :1)`)
    ...
    expectedResult.push(result)
    expectedQuery.push(`select raw_to_uuid(id) as "id", title as "title" from record where raw_to_uuid(id) like ('%' || :0 || '%') escape '\\'`)
    ...
    result = { id: '89bf68fc-7002-11ec-90d6-0242ac120003', title: 'My voice memo' }
    expectedResult.push(result)
    expectedQuery.push(`with with_uuit as (select id as id, title as title from record) select raw_to_uuid(id) as "id", title as "title" from with_uuit where raw_to_uuid(id) like ('%' || :0 || '%') escape '\\'`)
    expectedParams.push(`["7002"]`)
    expectedType.push(`selectOneRow`)
    ...
    expectedResult.push(result)
    expectedQuery.push(`select (select json_arrayagg(json_object('id' value raw_to_uuid(id), 'title' value title)) from record where raw_to_uuid(id) like ('%' || :0 || '%') escape '\\') as "records" from dual`)
    expectedParams.push(`["7002"]`)
    expectedType.push(`selectOneRow`)
    ...
    result = { records: [{ id: '89bf68fc-7002-11ec-90d6-0242ac120003', title: 'My voice memo' }] }
    expectedResult.push(result)
    expectedQuery.push(`select (select json_arrayagg(json_object('id' value raw_to_uuid(a_1_.id), 'title' value a_1_.title)) from (select id as id, title as title from record where raw_to_uuid(id) like ('%' || :0 || '%') escape '\\' order by id offset 0 rows) a_1_) as "records" from dual`)
    expectedParams.push(`["7002"]`)
    expectedType.push(`selectOneRow`)
    ...
    result = { records: [{ id: '89bf68fc-7002-11ec-90d6-0242ac120003', title: 'My voice memo' }] }
    expectedResult.push(result)
    expectedQuery.push(`select json_arrayagg(json_object('id' value raw_to_uuid(id), 'title' value title)) as "records" from record where raw_to_uuid(id) like ('%' || :0 || '%') escape '\\'`)
    expectedParams.push(`["7002"]`)
    expectedType.push(`selectOneRow`)
    ...
    result = []
    expectedResult.push(result)
    expectedQuery.push(`select first_name as "firstName", last_name as "lastName", birthday as "birthday" from customer where company_id = :0`)
    ...
    result = []
    expectedResult.push(result)
    expectedQuery.push(`select id as "id", first_name || :0 || last_name as "name", calculateAge(birthday) as "age" from customer`)
    expectedParams.push(`[" "]`)
    expectedType.push(`selectManyRows`)
    ...
    result = []
    expectedResult.push(result)
    expectedQuery.push(`with recursive_select_1(companyId, companyName, companyParentId, favouriteCustomerId) as (select id as companyId, id as companyName, parent_id as companyParentId, parent_id as favouriteCustomerId from company where id = :0 union all select company.id as companyId, company.id as companyName, company.parent_id as companyParentId, company.parent_id as favouriteCustomerId from company join recursive_select_1 on recursive_select_1.companyParentId = company.id) select companyId as "companyId", companyName as "companyName", companyParentId as "companyParentId", favouriteCustomerId as "favouriteCustomerId" from recursive_select_1`)
    expectedParams.push(`[10]`)
    expectedType.push(`selectManyRows`)

    expectedResult.push(0)
    expectedQuery.push(`with recursive_select_1(companyId, companyName, companyParentId, favouriteCustomerId) as (select id as companyId, id as companyName, parent_id as companyParentId, parent_id as favouriteCustomerId from company where id = :0 union all select company.id as companyId, company.id as companyName, company.parent_id as companyParentId, company.parent_id as favouriteCustomerId from company join recursive_select_1 on recursive_select_1.companyParentId = company.id) select count(*) from recursive_select_1`)
    expectedParams.push(`[10]`)
    expectedType.push(`selectOneColumnOneRow`)
    ...
    result = []
    expectedResult.push(result)
    expectedQuery.push(`select id as "companyId", id as "companyName", parent_id as "companyParentId", parent_id as "favouriteCustomerId" from company where id = :0`)
    expectedParams.push(`[10]`)
    expectedType.push(`selectManyRows`)

    expectedResult.push(0)
    expectedQuery.push(`select count(*) from company where id = :0`)
    expectedParams.push(`[10]`)
    expectedType.push(`selectOneColumnOneRow`)
    ...
    result = []
    expectedResult.push(result)
    expectedQuery.push(`select id as "id", name as "name", nvl((select count(*) as "result" from customer where company_id = company.id), :0) as "numberOfCustomers" from company`)
    ...
    result = 0
    expectedResult.push(result)
    expectedQuery.push(`select count(*) as "result" from customer where company_id = :0`)
    expectedParams.push(`[10]`)
    expectedType.push(`selectOneColumnOneRow`)
    ...
    expectedResult.push([])
    expectedQuery.push(`select id as "id", first_name as "firstName", last_name as "lastName" from customer where lower(first_name) like lower(:0 || '%') escape '\\' or lower(last_name) like lower(:1 || '%') escape '\\' group by id order by "firstName", "lastName" offset :2 rows fetch next :3 rows only`)
    expectedParams.push(`["Smi","Smi",20,10]`)
    expectedType.push(`selectManyRows`)
    expectedResult.push(0)
    expectedQuery.push(`with result_for_count as (select id as id, first_name as firstName, last_name as lastName from customer where lower(first_name) like lower(:0 || '%') escape '\\' or lower(last_name) like lower(:1 || '%') escape '\\' group by id) select count(*) from result_for_count`)
    expectedParams.push(`["Smi","Smi"]`)
    expectedType.push(`selectOneColumnOneRow`)
    ...
    expectedResult.push([])
    expectedQuery.push(`select distinct id as "id", first_name as "firstName", last_name as "lastName" from customer where lower(first_name) like lower(:0 || '%') escape '\\' or lower(last_name) like lower(:1 || '%') escape '\\' order by "firstName", "lastName" offset :2 rows fetch next :3 rows only`)
    expectedParams.push(`["Smi","Smi",20,10]`)
    expectedType.push(`selectManyRows`)
    expectedResult.push(0)
    expectedQuery.push(`with result_for_count as (select distinct id as id, first_name as firstName, last_name as lastName from customer where lower(first_name) like lower(:0 || '%') escape '\\' or lower(last_name) like lower(:1 || '%') escape '\\') select count(*) from result_for_count`)
    expectedParams.push(`["Smi","Smi"]`)
    expectedType.push(`selectOneColumnOneRow`)
    ...
    result = []
    expectedResult.push(result)
    expectedQuery.push(`select id as "id", name as "name" from company where lower(name) like lower('%' || :0 || '%') escape '\\' and parent_id = :1`)
    ...
    expectedQuery.push(`insert into customer (first_name, last_name, company_id) values (:0, :1, :2) returning id, first_name, last_name, birthday into :3, :4, :5, :6`)
    expectedParams.push(`["John","Smith",1,{"dir":3003,"as":"id"},{"dir":3003,"as":"firstName"},{"dir":3003,"as":"lastName"},{"dir":3003,"as":"birthday"}]`)
    expectedType.push(`insertReturningOneRow`)
    ...
    expectedResult.push(result)
    expectedQuery.push(`update customer set first_name = :0 where id = :1 returning first_name, birthday into :2, :3`)
    expectedParams.push(`["Ron",1,{"dir":3003,"as":"firstName"},{"dir":3003,"as":"birthday"}]`)
    expectedType.push(`updateReturningOneRow`)
    ...
    result = { firstName: 'Ron' }
    expectedResult.push(result)
    expectedQuery.push(`delete from customer where id = :0 returning first_name, birthday into :1, :2`)
    expectedParams.push(`[1,{"dir":3003,"as":"firstName"},{"dir":3003,"as":"birthday"}]`)
    expectedType.push(`deleteReturningOneRow`)
    ...
    expectedResult.push(result)
    expectedQuery.push(`select id as "id", name as "name", parent_id as "parentId", (select json_arrayagg(json_object('id' value id, 'firstName' value first_name, 'lastName' value last_name, 'birthday' value birthday)) as "result" from customer where company_id = company.id) as "customers" from company where id = :0`)
    expectedParams.push(`[1]`)
    expectedType.push(`selectOneRow`)
    ...
    result = []
    expectedResult.push(result)
    expectedQuery.push(`with companySubQuery as (select id as id, name as name from company) select customer.id as "id", customer.first_name as "firstName", customer.last_name as "lastName", companySubQuery.id as "company.id", companySubQuery.name as "company.name" from customer inner join companySubQuery on customer.company_id = companySubQuery.id where companySubQuery.name = :0 union all select customer.id as "id", customer.first_name as "firstName", customer.last_name as "lastName", companySubQuery.id as "company.id", companySubQuery.name as "company.name" from customer inner join companySubQuery on customer.company_id = companySubQuery.id where companySubQuery.name = :1`)
    ...
    result = []
    expectedResult.push(result)
    expectedQuery.push(`select sign(id) * power(abs(id), 1.0e0 / 3.0e0) as "idCubeRoot", log(10, id) as "idLog10", log(:0, id) as "idLogBase2" from customer where id = :1`)
    ...
    result = []
    expectedResult.push(result)
    expectedQuery.push(`select id as "id" from customer where (first_name collate BINARY) = :0`)
    ...
    expectedResult.push(result)
    expectedQuery.push(`select id as "id", replace(first_name collate BINARY_CI, :0 collate BINARY_CI, :1) collate USING_NLS_COMP as "cleaned" from customer where id = :2`)
