...
describe(ctx.label, () => {
    ...
    test('int-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select cm_int() from dual"`)
    ...
    test('bigint-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select cm_bigint() from dual"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
    ...
    test('double-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select cm_double() from dual"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        assertType<Exact<typeof v, number>>()
        expect(v).toBe(3.5)
    })
    ...
    test('boolean-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select cm_bool() from dual"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
    ...
    test('uuid-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select cm_uuid() from dual"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
    ...
    test('local-date-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select cm_date() from dual"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
    ...
    test('local-time-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select cm_time() from dual"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        assertType<Exact<typeof v, Date>>()
        expect(v).toBeInstanceOf(Date)
    })
    ...
    test('local-date-time-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select cm_datetime() from dual"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        assertType<Exact<typeof v, Date>>()
        expect(v).toBeInstanceOf(Date)
    })
    ...
    test('string-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select cm_str() from dual"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        assertType<Exact<typeof v, string>>()
        expect(v).toBe('hello')
    })
