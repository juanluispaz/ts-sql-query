...
// PostgreSQL-specific by intent, so on MySQL the tests are kept
...
describe(ctx.label, () => {
    ...
    // NOT-APPLICABLE: MySQL — ForceTypeCast emits a PostgreSQL `::<type>` placeholder cast; other dialects no-op
    /*
