...
describe(ctx.label, () => {
    ...
    test('equivalence/equals-and-not-equals', async () => {
        ...
        expect(ref.sql).toMatchInlineSnapshot(`"select id as id from issue where priority = $1 and priority <> $2 order by id"`)
    ...
    test('equivalence/is-and-is-not', async () => {
        ...
        expect(dynamic.sql).toBe(ref.sql)
        expect(dynamic.params).toEqual(ref.params)
        expect(ref.sql).toMatchInlineSnapshot(`"select id as id from issue where priority is not distinct from $1 and status is distinct from $2 order by id"`)
        expect(ref.params).toMatchInlineSnapshot(`
          [
            2,
            "closed",
    ...
    test('equivalence/in-and-not-in', async () => {
        ...
        expect(dynamic.sql).toBe(ref.sql)
        expect(dynamic.params).toEqual(ref.params)
        expect(ref.sql).toMatchInlineSnapshot(`"select id as id from issue where priority in ($1, $2) and priority not in ($3) order by id"`)
        expect(ref.params).toMatchInlineSnapshot(`
          [
            1,
            2,
    ...
    test('equivalence/comparable-operators', async () => {
        ...
        expect(dynamic.sql).toBe(ref.sql)
        expect(dynamic.params).toEqual(ref.params)
        expect(ref.sql).toMatchInlineSnapshot(`"select id as id from issue where priority > $1 and priority < $2 and priority >= $3 and priority <= $4 order by id"`)
        expect(ref.params).toMatchInlineSnapshot(`
          [
            1,
            9,
    ...
    test('equivalence/equals-insensitive-and-not-equals-insensitive', async () => {
        ...
        expect(dynamic.sql).toBe(ref.sql)
        expect(dynamic.params).toEqual(ref.params)
        expect(ref.sql).toMatchInlineSnapshot(`"select id as id from issue where lower(title) = lower($1) and lower(title) <> lower($2) order by id"`)
        expect(ref.params).toMatchInlineSnapshot(`
          [
            "Triage",
            "Draft",
    ...
    test('equivalence/like-family', async () => {
        ...
        expect(dynamic.sql).toBe(ref.sql)
        expect(dynamic.params).toEqual(ref.params)
        expect(ref.sql).toMatchInlineSnapshot(`"select id as id from issue where title like $1 and title not like $2 and title ilike $3 and title not ilike $4 order by id"`)
        expect(ref.params).toMatchInlineSnapshot(`
          [
            "%a%",
            "%b%",
    ...
    test('equivalence/affix-sensitive', async () => {
        ...
        expect(dynamic.sql).toBe(ref.sql)
        expect(dynamic.params).toEqual(ref.params)
        expect(ref.sql).toMatchInlineSnapshot(`"select id as id from issue where title like ($1 || '%') and title not like ($2 || '%') and title like ('%' || $3) and title not like ('%' || $4) and title like ('%' || $5 || '%') and title not like ('%' || $6 || '%') order by id"`)
        expect(ref.params).toMatchInlineSnapshot(`
          [
            "Re",
            "Un",
    ...
    test('equivalence/affix-insensitive', async () => {
        ...
        expect(dynamic.sql).toBe(ref.sql)
        expect(dynamic.params).toEqual(ref.params)
        expect(ref.sql).toMatchInlineSnapshot(`"select id as id from issue where title ilike ($1 || '%') and title not ilike ($2 || '%') and title ilike ('%' || $3) and title not ilike ('%' || $4) and title ilike ('%' || $5 || '%') and title not ilike ('%' || $6 || '%') order by id"`)
        expect(ref.params).toMatchInlineSnapshot(`
          [
            "Re",
            "Un",
    ...
    test('equivalence/if-value-maps-to-direct-if-value', async () => {
        ...
        expect(dynamic.sql).toBe(ref.sql)
        expect(dynamic.params).toEqual(ref.params)
        expect(ref.sql).toMatchInlineSnapshot(`"select id as id from issue where priority = $1 order by id"`)
        expect(ref.params).toMatchInlineSnapshot(`
          [
            7,
          ]
    ...
    test('equivalence/double-column-dispatch', async () => {
        ...
        expect(dynamic.sql).toBe(ref.sql)
        expect(dynamic.params).toEqual(ref.params)
        expect(ref.sql).toMatchInlineSnapshot(`"select id as id from issue where estimated_hours > $1 order by id"`)
        expect(ref.params).toMatchInlineSnapshot(`
          [
            2.5,
          ]
    ...
    test('equivalence/datetime-column-dispatch', async () => {
        ...
        expect(dynamic.sql).toBe(ref.sql)
        expect(dynamic.params).toEqual(ref.params)
        expect(ref.sql).toMatchInlineSnapshot(`"select id as id from issue where created_at >= $1 order by id"`)
        expect(ref.params).toMatchInlineSnapshot(`
          [
    ...
    test('equivalence/bigint-column-dispatch', async () => {
        ...
        expect(dynamic.sql).toBe(ref.sql)
        expect(dynamic.params).toEqual(ref.params)
        expect(ref.sql).toMatchInlineSnapshot(`"select id as id from issue where view_count > $1 order by id"`)
        expect(ref.params).toMatchInlineSnapshot(`
          [
            10n,
          ]
    ...
    test('equivalence/boolean-column-custom-adapter-dispatch', async () => {
        ...
        expect(dynamic.sql).toBe(ref.sql)
        expect(dynamic.params).toEqual(ref.params)
        expect(ref.sql).toMatchInlineSnapshot(`"select id as id from project where (published = 't') = $1 order by id"`)
        expect(ref.params).toMatchInlineSnapshot(`
          [
            true,
          ]
    ...
    test('equivalence/uuid-as-string-operator-path', async () => {
        ...
        expect(dynamic.sql).toBe(ref.sql)
        expect(dynamic.params).toEqual(ref.params)
        expect(ref.sql).toMatchInlineSnapshot(`"select id as id from issue where external_ref::text ilike ('%' || $1 || '%') order by id"`)
        expect(ref.params).toMatchInlineSnapshot(`
          [
            "abc",
          ]
    ...
    test('equivalence/and-combinator', async () => {
        ...
        expect(dynamic.sql).toBe(ref.sql)
        expect(dynamic.params).toEqual(ref.params)
        expect(ref.sql).toMatchInlineSnapshot(`"select id as id from issue where status = $1 and priority = $2 order by id"`)
        expect(ref.params).toMatchInlineSnapshot(`
          [
            "open",
            3,
    ...
    test('equivalence/or-combinator', async () => {
        ...
        expect(dynamic.sql).toBe(ref.sql)
        expect(dynamic.params).toEqual(ref.params)
        expect(ref.sql).toMatchInlineSnapshot(`"select id as id from issue where status = $1 or priority = $2 order by id"`)
        expect(ref.params).toMatchInlineSnapshot(`
          [
            "open",
            3,
    ...
    test('equivalence/not-combinator', async () => {
        ...
        expect(dynamic.sql).toBe(ref.sql)
        expect(dynamic.params).toEqual(ref.params)
        expect(ref.sql).toMatchInlineSnapshot(`"select id as id from issue where not (status = $1) order by id"`)
        expect(ref.params).toMatchInlineSnapshot(`
          [
            "closed",
          ]
    ...
    test('equivalence/if-value-equalable-family', async () => {
        ...
        expect(dynamic.sql).toBe(ref.sql)
        expect(dynamic.params).toEqual(ref.params)
        expect(ref.sql).toMatchInlineSnapshot(`"select id as id from issue where priority = $1 and priority <> $2 and priority is not distinct from $3 and priority is distinct from $4 and priority in ($5, $6) and priority not in ($7) order by id"`)
        expect(ref.params).toMatchInlineSnapshot(`
          [
            2,
            3,
    ...
    test('equivalence/if-value-string-equality-and-like-family', async () => {
        ...
        expect(dynamic.sql).toBe(ref.sql)
        expect(dynamic.params).toEqual(ref.params)
        expect(ref.sql).toMatchInlineSnapshot(`"select id as id from issue where lower(title) = lower($1) and lower(title) <> lower($2) and title like $3 and title not like $4 and title ilike $5 and title not ilike $6 order by id"`)
        expect(ref.params).toMatchInlineSnapshot(`
          [
            "Foo",
            "Bar",
