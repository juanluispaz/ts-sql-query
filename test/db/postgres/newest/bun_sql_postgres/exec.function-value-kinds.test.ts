...
describe(ctx.label, () => {
    ...
    test('int-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select cm_int()"`)
    ...
    test('bigint-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select cm_bigint()"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
    ...
    test('double-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select cm_double()"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        assertType<Exact<typeof v, number>>()
        expect(v).toBe(3.5)
    })
    ...
    test('boolean-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select cm_bool()"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
    ...
    test('uuid-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select cm_uuid()"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
    ...
    test('local-date-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select cm_date()"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
    ...
    test('local-time-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select cm_time()"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        assertType<Exact<typeof v, Date>>()
        expect(v).toBeInstanceOf(Date)
    })
    ...
    test('local-date-time-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select cm_datetime()"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        assertType<Exact<typeof v, Date>>()
        expect(v).toBeInstanceOf(Date)
    })
    ...
    test('string-required', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select cm_str()"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`[]`)
        assertType<Exact<typeof v, string>>()
        expect(v).toBe('hello')
    })
