...
describe(ctx.label, () => {
    ...
    test('has-aggregation/compound-with-no-aggregate-in-either-arm-reports-false', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "projectId" from project where organization_id = :0 union select project_id as "projectId" from issue order by 1"`)
    ...
    test('has-aggregation/compound-with-aggregate-in-the-first-arm-reports-aggregation', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select project_id as "projectId", count(id) as "issueCount" from issue group by project_id union select id as "projectId", :0 as "issueCount" from project where archived_at is not null order by 1"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            0,
          ]
    ...
    test('has-aggregation/compound-with-aggregate-only-in-the-second-arm-reports-aggregation', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"select id as "projectId", :0 as "issueCount" from project where archived_at is not null union select project_id as "projectId", count(id) as "issueCount" from issue group by project_id order by 1"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            0,
          ]
    ...
    test('has-aggregation/compound-customization-without-aggregate-reports-false', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"/* head */  select id as "projectId" from project where organization_id = :0 union select project_id as "projectId" from issue order by 1  /* tail keyed-by=project.slug */"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('has-aggregation/compound-customization-with-an-aggregate-in-a-fragment-reports-aggregation', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"/* head */  select id as "projectId" from project where organization_id = :0 union select project_id as "projectId" from issue order by 1  /* tail issues=(select count(id) as "result" from issue) */"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('has-aggregation/compound-customization-with-an-aggregate-in-the-before-query-fragment-reports-aggregation', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"/* head issues=(select count(id) as "result" from issue) */  select id as "projectId" from project where organization_id = :0 union select project_id as "projectId" from issue order by 1  /* tail */"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
    ...
    test('has-aggregation/compound-customization-with-an-aggregate-in-the-before-with-query-fragment-reports-aggregation', async () => {
        ...
        expect(ctx.lastSql).toMatchInlineSnapshot(`"/* head */  select id as "projectId" from project where organization_id = :0 union select project_id as "projectId" from issue order by 1  /* tail */"`)
        expect(ctx.lastParams).toMatchInlineSnapshot(`
          [
            1,
          ]
