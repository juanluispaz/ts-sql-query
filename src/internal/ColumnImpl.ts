...
import type { Column, ColumnWithDefaultValue, OptionalColumn, PrimaryKeyAutogeneratedColumn, PrimaryKeyColumn, __ColumnPrivate } from "../utils/Column"
import type { AnyDB } from "../databases"
import type { TypeAdapter } from "../TypeAdapter"
import type { SqlBuilder, ToSql } from "../sqlBuilders/SqlBuilder"
import { ValueSourceImpl } from "./ValueSourceImpl"

export class ColumnImpl<DB extends AnyDB, TABLE_OR_VIEW extends ITableOrView<DB>> extends ValueSourceImpl implements __ColumnPrivate, ToSql {
    ...
    constructor(table: TABLE_OR_VIEW, name: string, valueType: string, typeAdapter: TypeAdapter | undefined) {
