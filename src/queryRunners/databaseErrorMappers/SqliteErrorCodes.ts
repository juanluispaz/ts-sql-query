export const SQLITE_ERROR_CODE_NAMES = new Map<number, string>([
    [0, 'SQLITE_OK'],
    [1, 'SQLITE_ERROR'],
    [2, 'SQLITE_INTERNAL'],
    [3, 'SQLITE_PERM'],
...
export const SQLITE_ERROR_CODE_NUMBERS = new Map<string, number>(
    Array.from(SQLITE_ERROR_CODE_NAMES, ([number, name]) => [name, number])
)
