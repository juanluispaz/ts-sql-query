...
describe(ctx.label, () => {
    ...
    test('docs:basic/select-many', async () => {
        ...
        // doc-start
        const users = sync(connection.selectFrom(tAppUser)
            .select({
                id:       tAppUser.id,
    ...
    test('docs:basic/select-none-or-one', async () => {
        ...
        // doc-start
        const maybe = sync(connection.selectFrom(tProject)
    ...
    test('docs-extra:basic/select-one-column', async () => {
        ...
        const name = sync(connection.selectFrom(tProject)
            .where(tProject.id.equals(1))
    ...
    test('docs-extra:basic/select-count-all', async () => {
        ...
        const total = sync(connection.selectFrom(tProject)
            .selectCountAll()
            .executeSelectOne())
