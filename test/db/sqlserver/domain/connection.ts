...
export class DBConnection extends SqlServerConnection<'DBConnection'> {
    ...
    callRetBoolean(id: number): Promise<boolean> {
        return this.executeFunction('dbo.ret_flag', [this.const(id, 'int')], 'boolean', 'required')
    }
    callRetBooleanOptional(id: number): Promise<boolean | null> {
        return this.executeFunction('dbo.ret_flag', [this.const(id, 'int')], 'boolean', 'optional')
    }
    callRetDouble(id: number): Promise<number> {
        return this.executeFunction('dbo.estimated_total', [this.const(id, 'int')], 'double', 'required')
    }
    callRetDoubleOptional(id: number): Promise<number | null> {
        return this.executeFunction('dbo.estimated_total', [this.const(id, 'int')], 'double', 'optional')
    }
    callRetUuid(id: number): Promise<string> {
        return this.executeFunction('dbo.ret_uuid', [this.const(id, 'int')], 'uuid', 'required')
    }
    callRetUuidOptional(id: number): Promise<string | null> {
        return this.executeFunction('dbo.ret_uuid', [this.const(id, 'int')], 'uuid', 'optional')
    }
    callRetLocalDate(id: number): Promise<Date> {
        return this.executeFunction('dbo.ret_day', [this.const(id, 'int')], 'localDate', 'required')
    }
    callRetLocalDateOptional(id: number): Promise<Date | null> {
        return this.executeFunction('dbo.ret_day', [this.const(id, 'int')], 'localDate', 'optional')
    }
    callRetLocalTime(id: number): Promise<Date> {
        return this.executeFunction('dbo.ret_clock', [this.const(id, 'int')], 'localTime', 'required')
    }
    callRetLocalTimeOptional(id: number): Promise<Date | null> {
        return this.executeFunction('dbo.ret_clock', [this.const(id, 'int')], 'localTime', 'optional')
    }
    callRetEnum(id: number): Promise<WorklogActivity> {
        return this.executeFunction<WorklogActivity>('dbo.ret_activity', [this.const(id, 'int')], 'enum', 'WorklogActivity', 'required')
    }
    callRetEnumOptional(id: number): Promise<WorklogActivity | null> {
        return this.executeFunction<WorklogActivity>('dbo.ret_activity', [this.const(id, 'int')], 'enum', 'WorklogActivity', 'optional')
    }
    callRetCustom(id: number): Promise<ReleaseChannel> {
        return this.executeFunction<ReleaseChannel>('dbo.ret_channel', [this.const(id, 'int')], 'custom', 'ReleaseChannel', 'required')
    }
    callRetCustomOptional(id: number): Promise<ReleaseChannel | null> {
        return this.executeFunction<ReleaseChannel>('dbo.ret_channel', [this.const(id, 'int')], 'custom', 'ReleaseChannel', 'optional')
    }
    callRetCustomComparable(id: number): Promise<string> {
        return this.executeFunction<string>('dbo.ret_semver', [this.const(id, 'int')], 'customComparable', 'Semver', 'required')
    }
    callRetCustomComparableOptional(id: number): Promise<string | null> {
        return this.executeFunction<string>('dbo.ret_semver', [this.const(id, 'int')], 'customComparable', 'Semver', 'optional')
    }
    callRetCustomInt(id: number): Promise<number> {
        return this.executeFunction<number>('dbo.count_open_issues', [this.const(id, 'int')], 'customInt', 'Cents', 'required')
    }
    callRetCustomIntOptional(id: number): Promise<number | null> {
        return this.executeFunction<number>('dbo.count_open_issues', [this.const(id, 'int')], 'customInt', 'Cents', 'optional')
    }
    callRetCustomUuid(id: number): Promise<string> {
        return this.executeFunction<string>('dbo.ret_uuid', [this.const(id, 'int')], 'customUuid', 'SigningKey', 'required')
    }
    callRetCustomUuidOptional(id: number): Promise<string | null> {
        return this.executeFunction<string>('dbo.ret_uuid', [this.const(id, 'int')], 'customUuid', 'SigningKey', 'optional')
    }
    callRetCustomLocalDate(id: number): Promise<Date> {
        return this.executeFunction<Date>('dbo.ret_day', [this.const(id, 'int')], 'customLocalDate', 'ReleaseDay', 'required')
    }
    callRetCustomLocalDateOptional(id: number): Promise<Date | null> {
        return this.executeFunction<Date>('dbo.ret_day', [this.const(id, 'int')], 'customLocalDate', 'ReleaseDay', 'optional')
    }
    callRetCustomLocalTime(id: number): Promise<Date> {
        return this.executeFunction<Date>('dbo.ret_clock', [this.const(id, 'int')], 'customLocalTime', 'CutoffClock', 'required')
    }
    callRetCustomLocalTimeOptional(id: number): Promise<Date | null> {
        return this.executeFunction<Date>('dbo.ret_clock', [this.const(id, 'int')], 'customLocalTime', 'CutoffClock', 'optional')
    }
    callRetCustomLocalDateTime(id: number): Promise<Date> {
        return this.executeFunction<Date>('dbo.latest_issue_at', [this.const(id, 'int')], 'customLocalDateTime', 'SignOffStamp', 'required')
    }
    callRetCustomLocalDateTimeOptional(id: number): Promise<Date | null> {
        return this.executeFunction<Date>('dbo.latest_issue_at', [this.const(id, 'int')], 'customLocalDateTime', 'SignOffStamp', 'optional')
    }
    ...
    callCmInt(): Promise<number> {
        return this.executeFunction('dbo.cm_int', [], 'int', 'required')
    }
    callCmIntOpt(): Promise<number | null> {
        return this.executeFunction('dbo.cm_int', [], 'int', 'optional')
    }
    callCmIntAdapter(): Promise<number> {
        return this.executeFunction('dbo.cm_int', [], 'int', 'required', fnNumberTimesTen)
    }
    callCmIntOptAdapter(): Promise<number | null> {
        return this.executeFunction('dbo.cm_int', [], 'int', 'optional', fnNumberTimesTen)
    }

    // bigint (cm_bigint)
    callCmBigint(): Promise<bigint> {
        return this.executeFunction('dbo.cm_bigint', [], 'bigint', 'required')
    }
    callCmBigintOpt(): Promise<bigint | null> {
        return this.executeFunction('dbo.cm_bigint', [], 'bigint', 'optional')
    }
    callCmBigintAdapter(): Promise<bigint> {
        return this.executeFunction('dbo.cm_bigint', [], 'bigint', 'required', fnBigintTimesTen)
    }
    callCmBigintOptAdapter(): Promise<bigint | null> {
        return this.executeFunction('dbo.cm_bigint', [], 'bigint', 'optional', fnBigintTimesTen)
    }

    // double (cm_double)
    callCmDouble(): Promise<number> {
        return this.executeFunction('dbo.cm_double', [], 'double', 'required')
    }
    callCmDoubleOpt(): Promise<number | null> {
        return this.executeFunction('dbo.cm_double', [], 'double', 'optional')
    }
    callCmDoubleAdapter(): Promise<number> {
        return this.executeFunction('dbo.cm_double', [], 'double', 'required', fnNumberTimesTen)
    }
    callCmDoubleOptAdapter(): Promise<number | null> {
        return this.executeFunction('dbo.cm_double', [], 'double', 'optional', fnNumberTimesTen)
    }

    // boolean (cm_bool)
    callCmBoolean(): Promise<boolean> {
        return this.executeFunction('dbo.cm_bool', [], 'boolean', 'required')
    }
    callCmBooleanOpt(): Promise<boolean | null> {
        return this.executeFunction('dbo.cm_bool', [], 'boolean', 'optional')
    }
    callCmBooleanAdapter(): Promise<boolean> {
        return this.executeFunction('dbo.cm_bool', [], 'boolean', 'required', fnBoolNegate)
    }
    callCmBooleanOptAdapter(): Promise<boolean | null> {
        return this.executeFunction('dbo.cm_bool', [], 'boolean', 'optional', fnBoolNegate)
    }

    // uuid (cm_uuid)
    callCmUuid(): Promise<string> {
        return this.executeFunction('dbo.cm_uuid', [], 'uuid', 'required')
    }
    callCmUuidOpt(): Promise<string | null> {
        return this.executeFunction('dbo.cm_uuid', [], 'uuid', 'optional')
    }
    callCmUuidAdapter(): Promise<string> {
        return this.executeFunction('dbo.cm_uuid', [], 'uuid', 'required', fnUuidBracket)
    }
    callCmUuidOptAdapter(): Promise<string | null> {
        return this.executeFunction('dbo.cm_uuid', [], 'uuid', 'optional', fnUuidBracket)
    }

    // localDate (cm_date)
    callCmLocalDate(): Promise<Date> {
        return this.executeFunction('dbo.cm_date', [], 'localDate', 'required')
    }
    callCmLocalDateOpt(): Promise<Date | null> {
        return this.executeFunction('dbo.cm_date', [], 'localDate', 'optional')
    }
    callCmLocalDateAdapter(): Promise<Date> {
        return this.executeFunction('dbo.cm_date', [], 'localDate', 'required', shiftHourAdapter)
    }
    callCmLocalDateOptAdapter(): Promise<Date | null> {
        return this.executeFunction('dbo.cm_date', [], 'localDate', 'optional', shiftHourAdapter)
    }

    // localTime (cm_time)
    callCmLocalTime(): Promise<Date> {
        return this.executeFunction('dbo.cm_time', [], 'localTime', 'required')
    }
    callCmLocalTimeOpt(): Promise<Date | null> {
        return this.executeFunction('dbo.cm_time', [], 'localTime', 'optional')
    }
    callCmLocalTimeAdapter(): Promise<Date> {
        return this.executeFunction('dbo.cm_time', [], 'localTime', 'required', shiftHourAdapter)
    }
    callCmLocalTimeOptAdapter(): Promise<Date | null> {
        return this.executeFunction('dbo.cm_time', [], 'localTime', 'optional', shiftHourAdapter)
    }

    // localDateTime (cm_datetime)
    callCmLocalDateTime(): Promise<Date> {
        return this.executeFunction('dbo.cm_datetime', [], 'localDateTime', 'required')
    }
    callCmLocalDateTimeOpt(): Promise<Date | null> {
        return this.executeFunction('dbo.cm_datetime', [], 'localDateTime', 'optional')
    }
    callCmLocalDateTimeAdapter(): Promise<Date> {
        return this.executeFunction('dbo.cm_datetime', [], 'localDateTime', 'required', shiftHourAdapter)
    }
    callCmLocalDateTimeOptAdapter(): Promise<Date | null> {
        return this.executeFunction('dbo.cm_datetime', [], 'localDateTime', 'optional', shiftHourAdapter)
    }

    // string (cm_str)
    callCmString(): Promise<string> {
        return this.executeFunction('dbo.cm_str', [], 'string', 'required')
    }
    callCmStringOpt(): Promise<string | null> {
        return this.executeFunction('dbo.cm_str', [], 'string', 'optional')
    }
    callCmStringAdapter(): Promise<string> {
        return this.executeFunction('dbo.cm_str', [], 'string', 'required', bracketAdapter)
    }
    callCmStringOptAdapter(): Promise<string | null> {
        return this.executeFunction('dbo.cm_str', [], 'string', 'optional', bracketAdapter)
    }

    // enum (cm_str, WorklogActivity)
    callCmEnum(): Promise<WorklogActivity> {
        return this.executeFunction<WorklogActivity>('dbo.cm_str', [], 'enum', 'WorklogActivity', 'required')
    }
    callCmEnumOpt(): Promise<WorklogActivity | null> {
        return this.executeFunction<WorklogActivity>('dbo.cm_str', [], 'enum', 'WorklogActivity', 'optional')
    }
    callCmEnumAdapter(): Promise<WorklogActivity> {
        return this.executeFunction<WorklogActivity>('dbo.cm_str', [], 'enum', 'WorklogActivity', 'required', bracketAdapter)
    }
    callCmEnumOptAdapter(): Promise<WorklogActivity | null> {
        return this.executeFunction<WorklogActivity>('dbo.cm_str', [], 'enum', 'WorklogActivity', 'optional', bracketAdapter)
    }

    // custom (cm_str, ReleaseChannel)
    callCmCustom(): Promise<ReleaseChannel> {
        return this.executeFunction<ReleaseChannel>('dbo.cm_str', [], 'custom', 'ReleaseChannel', 'required')
    }
    callCmCustomOpt(): Promise<ReleaseChannel | null> {
        return this.executeFunction<ReleaseChannel>('dbo.cm_str', [], 'custom', 'ReleaseChannel', 'optional')
    }
    callCmCustomAdapter(): Promise<ReleaseChannel> {
        return this.executeFunction<ReleaseChannel>('dbo.cm_str', [], 'custom', 'ReleaseChannel', 'required', bracketAdapter)
    }
    callCmCustomOptAdapter(): Promise<ReleaseChannel | null> {
        return this.executeFunction<ReleaseChannel>('dbo.cm_str', [], 'custom', 'ReleaseChannel', 'optional', bracketAdapter)
    }

    // customComparable (cm_str, Semver)
    callCmCustomComparable(): Promise<string> {
        return this.executeFunction<string>('dbo.cm_str', [], 'customComparable', 'Semver', 'required')
    }
    callCmCustomComparableOpt(): Promise<string | null> {
        return this.executeFunction<string>('dbo.cm_str', [], 'customComparable', 'Semver', 'optional')
    }
    callCmCustomComparableAdapter(): Promise<string> {
        return this.executeFunction<string>('dbo.cm_str', [], 'customComparable', 'Semver', 'required', bracketAdapter)
    }
    callCmCustomComparableOptAdapter(): Promise<string | null> {
        return this.executeFunction<string>('dbo.cm_str', [], 'customComparable', 'Semver', 'optional', bracketAdapter)
    }

    // customInt (cm_int, Cents)
    callCmCustomInt(): Promise<number> {
        return this.executeFunction<number>('dbo.cm_int', [], 'customInt', 'Cents', 'required')
    }
    callCmCustomIntOpt(): Promise<number | null> {
        return this.executeFunction<number>('dbo.cm_int', [], 'customInt', 'Cents', 'optional')
    }
    callCmCustomIntAdapter(): Promise<number> {
        return this.executeFunction<number>('dbo.cm_int', [], 'customInt', 'Cents', 'required', fnNumberTimesTen)
    }
    callCmCustomIntOptAdapter(): Promise<number | null> {
        return this.executeFunction<number>('dbo.cm_int', [], 'customInt', 'Cents', 'optional', fnNumberTimesTen)
    }

    // customUuid (cm_uuid, SigningKey)
    callCmCustomUuid(): Promise<string> {
        return this.executeFunction<string>('dbo.cm_uuid', [], 'customUuid', 'SigningKey', 'required')
    }
    callCmCustomUuidOpt(): Promise<string | null> {
        return this.executeFunction<string>('dbo.cm_uuid', [], 'customUuid', 'SigningKey', 'optional')
    }
    callCmCustomUuidAdapter(): Promise<string> {
        return this.executeFunction<string>('dbo.cm_uuid', [], 'customUuid', 'SigningKey', 'required', fnUuidBracket)
    }
    callCmCustomUuidOptAdapter(): Promise<string | null> {
        return this.executeFunction<string>('dbo.cm_uuid', [], 'customUuid', 'SigningKey', 'optional', fnUuidBracket)
    }

    // customDouble (cm_double, Money)
    callCmCustomDouble(): Promise<number> {
        return this.executeFunction<number>('dbo.cm_double', [], 'customDouble', 'Money', 'required')
    }
    callCmCustomDoubleOpt(): Promise<number | null> {
        return this.executeFunction<number>('dbo.cm_double', [], 'customDouble', 'Money', 'optional')
    }
    callCmCustomDoubleAdapter(): Promise<number> {
        return this.executeFunction<number>('dbo.cm_double', [], 'customDouble', 'Money', 'required', fnNumberTimesTen)
    }
    callCmCustomDoubleOptAdapter(): Promise<number | null> {
        return this.executeFunction<number>('dbo.cm_double', [], 'customDouble', 'Money', 'optional', fnNumberTimesTen)
    }

    // customLocalDate (cm_date, ReleaseDay)
    callCmCustomLocalDate(): Promise<Date> {
        return this.executeFunction<Date>('dbo.cm_date', [], 'customLocalDate', 'ReleaseDay', 'required')
    }
    callCmCustomLocalDateOpt(): Promise<Date | null> {
        return this.executeFunction<Date>('dbo.cm_date', [], 'customLocalDate', 'ReleaseDay', 'optional')
    }
    callCmCustomLocalDateAdapter(): Promise<Date> {
        return this.executeFunction<Date>('dbo.cm_date', [], 'customLocalDate', 'ReleaseDay', 'required', shiftHourAdapter)
    }
    callCmCustomLocalDateOptAdapter(): Promise<Date | null> {
        return this.executeFunction<Date>('dbo.cm_date', [], 'customLocalDate', 'ReleaseDay', 'optional', shiftHourAdapter)
    }

    // customLocalTime (cm_time, CutoffClock)
    callCmCustomLocalTime(): Promise<Date> {
        return this.executeFunction<Date>('dbo.cm_time', [], 'customLocalTime', 'CutoffClock', 'required')
    }
    callCmCustomLocalTimeOpt(): Promise<Date | null> {
        return this.executeFunction<Date>('dbo.cm_time', [], 'customLocalTime', 'CutoffClock', 'optional')
    }
    callCmCustomLocalTimeAdapter(): Promise<Date> {
        return this.executeFunction<Date>('dbo.cm_time', [], 'customLocalTime', 'CutoffClock', 'required', shiftHourAdapter)
    }
    callCmCustomLocalTimeOptAdapter(): Promise<Date | null> {
        return this.executeFunction<Date>('dbo.cm_time', [], 'customLocalTime', 'CutoffClock', 'optional', shiftHourAdapter)
    }

    // customLocalDateTime (cm_datetime, SignOffStamp)
    callCmCustomLocalDateTime(): Promise<Date> {
        return this.executeFunction<Date>('dbo.cm_datetime', [], 'customLocalDateTime', 'SignOffStamp', 'required')
    }
    callCmCustomLocalDateTimeOpt(): Promise<Date | null> {
        return this.executeFunction<Date>('dbo.cm_datetime', [], 'customLocalDateTime', 'SignOffStamp', 'optional')
    }
    callCmCustomLocalDateTimeAdapter(): Promise<Date> {
        return this.executeFunction<Date>('dbo.cm_datetime', [], 'customLocalDateTime', 'SignOffStamp', 'required', shiftHourAdapter)
    }
    callCmCustomLocalDateTimeOptAdapter(): Promise<Date | null> {
        return this.executeFunction<Date>('dbo.cm_datetime', [], 'customLocalDateTime', 'SignOffStamp', 'optional', shiftHourAdapter)
    }
...
// View `column`/`optionalColumn` WITH a trailing TypeAdapter per kind — the View
// analog of tColMatrixColumnAdapter / tColMatrixOptionalAdapter. Same read
// SQL/value as the no-adapter vColMatrix; the adapter runs on transformValueFromDB
// (numeric ×10, bigint ×10n, boolean negate, uuid lowercase+bracket, string
// bracket, Date +1h). Exercises the View column-factory trailing-adapter overload.
export const vColMatrixAdapter = new class VColMatrixAdapter extends View<DBConnection, 'VColMatrixAdapter'> {
    id           = this.column('id', 'int')
    mInt         = this.column('m_int', 'int', colMatrixNumberX10)
    mBigint      = this.column('m_bigint', 'bigint', colMatrixBigintX10)
    mDouble      = this.column('m_double', 'double', colMatrixNumberX10)
    ...
    signOff      = this.column<Date, 'SignOffStamp'>('m_datetime', 'customLocalDateTime', 'SignOffStamp', colMatrixShiftHour)
    activity     = this.column<WorklogActivity, 'WorklogActivity'>('m_str', 'enum', 'WorklogActivity', colMatrixStringBracket)
    oInt         = this.optionalColumn('m_int', 'int', colMatrixNumberX10)
    oBigint      = this.optionalColumn('m_bigint', 'bigint', colMatrixBigintX10)
    oDouble      = this.optionalColumn('m_double', 'double', colMatrixNumberX10)
    oBool        = this.optionalColumn('m_bool', 'boolean', colMatrixBoolNegate)
    oUuid        = this.optionalColumn('m_uuid', 'uuid', colMatrixUuidBracket)
    oDate        = this.optionalColumn('m_date', 'localDate', colMatrixShiftHour)
    oTime        = this.optionalColumn('m_time', 'localTime', colMatrixShiftHour)
    oDatetime    = this.optionalColumn('m_datetime', 'localDateTime', colMatrixShiftHour)
    oStr         = this.optionalColumn('m_str', 'string', colMatrixStringBracket)
    oCents       = this.optionalColumn<number, 'Cents'>('m_int', 'customInt', 'Cents', colMatrixNumberX10)
    oMoney       = this.optionalColumn<number, 'Money'>('m_double', 'customDouble', 'Money', colMatrixNumberX10)
    oSigningKey  = this.optionalColumn<string, 'SigningKey'>('m_uuid', 'customUuid', 'SigningKey', colMatrixUuidBracket)
    oSemver      = this.optionalColumn<string, 'Semver'>('m_str', 'customComparable', 'Semver', colMatrixStringBracket)
    oChannel     = this.optionalColumn<ReleaseChannel, 'ReleaseChannel'>('m_str', 'custom', 'ReleaseChannel', colMatrixStringBracket)
    oReleaseDay  = this.optionalColumn<Date, 'ReleaseDay'>('m_date', 'customLocalDate', 'ReleaseDay', colMatrixShiftHour)
    oCutoffClock = this.optionalColumn<Date, 'CutoffClock'>('m_time', 'customLocalTime', 'CutoffClock', colMatrixShiftHour)
    oSignOff     = this.optionalColumn<Date, 'SignOffStamp'>('m_datetime', 'customLocalDateTime', 'SignOffStamp', colMatrixShiftHour)
    oActivity    = this.optionalColumn<WorklogActivity, 'WorklogActivity'>('m_str', 'enum', 'WorklogActivity', colMatrixStringBracket)
    constructor() { super('col_matrix_view') }
}()

// virtualColumnFromFragment / optionalVirtualColumnFromFragment WITH a trailing
// TypeAdapter, per kind — the Table virtual-column trailing-adapter overload
// (required `m*` + optional `o*`). Each virtual fragment renders a base col_matrix column
// object (`b*`, not projected) so the emitted read SQL/value coincides with the plain
// column+adapter cell; the typed virtual READ PATH is what differs. Same colMatrix
// adapters (numeric ×10, bigint ×10n, boolean negate, uuid lowercase+bracket, string
// bracket, Date +1h).
export const tColMatrixVirtualAdapter = new class TColMatrixVirtualAdapter extends Table<DBConnection, 'TColMatrixVirtualAdapter'> {
    id           = this.primaryKey('id', 'int')
    bInt         = this.column('m_int', 'int')
    bBigint      = this.column('m_bigint', 'bigint')
    bDouble      = this.column('m_double', 'double')
    bBool        = this.column('m_bool', 'boolean')
    bUuid        = this.column('m_uuid', 'uuid')
    bDate        = this.column('m_date', 'localDate')
    bTime        = this.column('m_time', 'localTime')
    bDatetime    = this.column('m_datetime', 'localDateTime')
    bStr         = this.column('m_str', 'string')
    mInt         = this.virtualColumnFromFragment('int', (fragment) => fragment.sql`${this.bInt}`, colMatrixNumberX10)
    mBigint      = this.virtualColumnFromFragment('bigint', (fragment) => fragment.sql`${this.bBigint}`, colMatrixBigintX10)
    mDouble      = this.virtualColumnFromFragment('double', (fragment) => fragment.sql`${this.bDouble}`, colMatrixNumberX10)
    mBool        = this.virtualColumnFromFragment('boolean', (fragment) => fragment.sql`${this.bBool}`, colMatrixBoolNegate)
    mUuid        = this.virtualColumnFromFragment('uuid', (fragment) => fragment.sql`${this.bUuid}`, colMatrixUuidBracket)
    mDate        = this.virtualColumnFromFragment('localDate', (fragment) => fragment.sql`${this.bDate}`, colMatrixShiftHour)
    mTime        = this.virtualColumnFromFragment('localTime', (fragment) => fragment.sql`${this.bTime}`, colMatrixShiftHour)
    mDatetime    = this.virtualColumnFromFragment('localDateTime', (fragment) => fragment.sql`${this.bDatetime}`, colMatrixShiftHour)
    mStr         = this.virtualColumnFromFragment('string', (fragment) => fragment.sql`${this.bStr}`, colMatrixStringBracket)
    cents        = this.virtualColumnFromFragment<number, 'Cents'>('customInt', 'Cents', (fragment) => fragment.sql`${this.bInt}`, colMatrixNumberX10)
    money        = this.virtualColumnFromFragment<number, 'Money'>('customDouble', 'Money', (fragment) => fragment.sql`${this.bDouble}`, colMatrixNumberX10)
    signingKey   = this.virtualColumnFromFragment<string, 'SigningKey'>('customUuid', 'SigningKey', (fragment) => fragment.sql`${this.bUuid}`, colMatrixUuidBracket)
    semver       = this.virtualColumnFromFragment<string, 'Semver'>('customComparable', 'Semver', (fragment) => fragment.sql`${this.bStr}`, colMatrixStringBracket)
    channel      = this.virtualColumnFromFragment<ReleaseChannel, 'ReleaseChannel'>('custom', 'ReleaseChannel', (fragment) => fragment.sql`${this.bStr}`, colMatrixStringBracket)
    releaseDay   = this.virtualColumnFromFragment<Date, 'ReleaseDay'>('customLocalDate', 'ReleaseDay', (fragment) => fragment.sql`${this.bDate}`, colMatrixShiftHour)
    cutoffClock  = this.virtualColumnFromFragment<Date, 'CutoffClock'>('customLocalTime', 'CutoffClock', (fragment) => fragment.sql`${this.bTime}`, colMatrixShiftHour)
    signOff      = this.virtualColumnFromFragment<Date, 'SignOffStamp'>('customLocalDateTime', 'SignOffStamp', (fragment) => fragment.sql`${this.bDatetime}`, colMatrixShiftHour)
    activity     = this.virtualColumnFromFragment<WorklogActivity, 'WorklogActivity'>('enum', 'WorklogActivity', (fragment) => fragment.sql`${this.bStr}`, colMatrixStringBracket)
    oInt         = this.optionalVirtualColumnFromFragment('int', (fragment) => fragment.sql`${this.bInt}`, colMatrixNumberX10)
    oBigint      = this.optionalVirtualColumnFromFragment('bigint', (fragment) => fragment.sql`${this.bBigint}`, colMatrixBigintX10)
    oDouble      = this.optionalVirtualColumnFromFragment('double', (fragment) => fragment.sql`${this.bDouble}`, colMatrixNumberX10)
    oBool        = this.optionalVirtualColumnFromFragment('boolean', (fragment) => fragment.sql`${this.bBool}`, colMatrixBoolNegate)
    oUuid        = this.optionalVirtualColumnFromFragment('uuid', (fragment) => fragment.sql`${this.bUuid}`, colMatrixUuidBracket)
    oDate        = this.optionalVirtualColumnFromFragment('localDate', (fragment) => fragment.sql`${this.bDate}`, colMatrixShiftHour)
    oTime        = this.optionalVirtualColumnFromFragment('localTime', (fragment) => fragment.sql`${this.bTime}`, colMatrixShiftHour)
    oDatetime    = this.optionalVirtualColumnFromFragment('localDateTime', (fragment) => fragment.sql`${this.bDatetime}`, colMatrixShiftHour)
    oStr         = this.optionalVirtualColumnFromFragment('string', (fragment) => fragment.sql`${this.bStr}`, colMatrixStringBracket)
    oCents       = this.optionalVirtualColumnFromFragment<number, 'Cents'>('customInt', 'Cents', (fragment) => fragment.sql`${this.bInt}`, colMatrixNumberX10)
    oMoney       = this.optionalVirtualColumnFromFragment<number, 'Money'>('customDouble', 'Money', (fragment) => fragment.sql`${this.bDouble}`, colMatrixNumberX10)
    oSigningKey  = this.optionalVirtualColumnFromFragment<string, 'SigningKey'>('customUuid', 'SigningKey', (fragment) => fragment.sql`${this.bUuid}`, colMatrixUuidBracket)
    oSemver      = this.optionalVirtualColumnFromFragment<string, 'Semver'>('customComparable', 'Semver', (fragment) => fragment.sql`${this.bStr}`, colMatrixStringBracket)
    oChannel     = this.optionalVirtualColumnFromFragment<ReleaseChannel, 'ReleaseChannel'>('custom', 'ReleaseChannel', (fragment) => fragment.sql`${this.bStr}`, colMatrixStringBracket)
    oReleaseDay  = this.optionalVirtualColumnFromFragment<Date, 'ReleaseDay'>('customLocalDate', 'ReleaseDay', (fragment) => fragment.sql`${this.bDate}`, colMatrixShiftHour)
    oCutoffClock = this.optionalVirtualColumnFromFragment<Date, 'CutoffClock'>('customLocalTime', 'CutoffClock', (fragment) => fragment.sql`${this.bTime}`, colMatrixShiftHour)
    oSignOff     = this.optionalVirtualColumnFromFragment<Date, 'SignOffStamp'>('customLocalDateTime', 'SignOffStamp', (fragment) => fragment.sql`${this.bDatetime}`, colMatrixShiftHour)
    oActivity    = this.optionalVirtualColumnFromFragment<WorklogActivity, 'WorklogActivity'>('enum', 'WorklogActivity', (fragment) => fragment.sql`${this.bStr}`, colMatrixStringBracket)
    constructor() { super('col_matrix') }
}()

// virtualColumnFromFragment / optionalVirtualColumnFromFragment WITH a trailing
// TypeAdapter, per kind — the View virtual-column trailing-adapter overload
// (required `m*` + optional `o*`). Each virtual fragment renders a base col_matrix column
// object (`b*`, not projected) so the emitted read SQL/value coincides with the plain
// column+adapter cell; the typed virtual READ PATH is what differs. Same colMatrix
// adapters (numeric ×10, bigint ×10n, boolean negate, uuid lowercase+bracket, string
// bracket, Date +1h).
export const vColMatrixVirtualAdapter = new class VColMatrixVirtualAdapter extends View<DBConnection, 'VColMatrixVirtualAdapter'> {
    id           = this.column('id', 'int')
    bInt         = this.column('m_int', 'int')
    bBigint      = this.column('m_bigint', 'bigint')
    bDouble      = this.column('m_double', 'double')
